...
public class DEV_TC_1409_VerifyTheDisplayingOfInternalNotesInEditRideModeAfterBookingARideInDispatchPortal_Main
		extends TestBase {
	...
	@FindBy(xpath = "(//*[@name='passengerNotes'])[1]")
	WebElement passengerNotes;

	@FindBy(xpath = "(//*[@name='internalNotes'])[1]")
	...
	@FindBy(xpath = "//*[text()='Internal Notes']//following::p")
	...
	public DEV_TC_1409_VerifyTheDisplayingOfInternalNotesInEditRideModeAfterBookingARideInDispatchPortal_Main(
			WebDriver driver) {
		try {
			this.driver = driver;
...
//					"2FA Validation Status for Script - " + getClass().getSimpleName() + " = " + visibilityStatus);
	...
	public void enterDate() {
		try {
			...
			if (currDay >= lastDateofMonth - 2) {
				...
				String dayOfMonthXpath = "//span[@class='MuiIconButton-label']//following::p[text()='"
	...
	public Boolean VisibilityOfsearchfield(Boolean visibilityStatus) {
		try {
	...
	public Boolean visibilityOfEditRideBtn(Boolean visibilityStatus2, String tripID) {
		try {
			if (editRideDetailsBtn.isDisplayed())
				visibilityStatus = true;
			else
				visibilityStatus = false;
		} catch (Exception e) {
	...
	public Boolean visibilityOfSucccessConfirmationMessage(Boolean visibilityStatus2) {
		try {
			String msgText = "";
			WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
			WebElement displayStatus = wait.until(ExpectedConditions.visibilityOf(alertMessge));
	...
	public void enterSearch() {
		try {
			searchUser.sendKeys(prop.getProperty("dispatchadminMail"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
