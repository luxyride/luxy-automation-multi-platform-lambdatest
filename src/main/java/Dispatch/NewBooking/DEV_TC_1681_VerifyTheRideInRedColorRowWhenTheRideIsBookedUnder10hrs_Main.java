...
public class DEV_TC_1681_VerifyTheRideInRedColorRowWhenTheRideIsBookedUnder10hrs_Main extends TestBase {
	...
	public DEV_TC_1681_VerifyTheRideInRedColorRowWhenTheRideIsBookedUnder10hrs_Main(WebDriver driver) {
		try {
			this.driver = driver;
	...
	public void enterDate(Boolean todaysFlag, Boolean modifyDateFlag) {
		try {
			...
			if (todaysFlag == true) {
				...
				// Select Date of 1 day after based on Current Date:
				else {
					String currDate = currMonth + "-" + currDay + "-" + currYear;
	...
	public Map<String, Integer> enterTime(String scenario, Boolean lessThan10hrs, Map<String, Integer> timeHours) {
		try {
