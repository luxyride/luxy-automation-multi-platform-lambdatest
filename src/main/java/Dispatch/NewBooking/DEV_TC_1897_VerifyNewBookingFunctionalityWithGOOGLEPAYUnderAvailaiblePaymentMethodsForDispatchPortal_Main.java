...
public class DEV_TC_1897_VerifyNewBookingFunctionalityWithGOOGLEPAYUnderAvailaiblePaymentMethodsForDispatchPortal_Main extends TestBase {
	...
	public DEV_TC_1897_VerifyNewBookingFunctionalityWithGOOGLEPAYUnderAvailaiblePaymentMethodsForDispatchPortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
...
//					"2FA Validation Status for Script - " + getClass().getSimpleName() + " = " + visibilityStatus);
	...
	public Boolean visibilityOfPaymentOptions(Boolean visibilityStatus) {
		try {
			if (cardOption.isDisplayed()&&  gpayOption.isDisplayed() &&paypalOption.isDisplayed()  && venmoOption.isDisplayed())
				visibilityStatus = true;
			else
				visibilityStatus = false;
		} catch (Exception e) {
