...
public class DEV_TC_1032_VerificationOfNewBookingAndEditRideDetailsFromDispatchSite_Main extends TestBase {
	...
	public DEV_TC_1032_VerificationOfNewBookingAndEditRideDetailsFromDispatchSite_Main(WebDriver driver) {
		try {
			this.driver = driver;
