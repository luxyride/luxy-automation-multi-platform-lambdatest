...
public class DEV_TC_88_VerifyTheGetQouteFunctionality_Main extends TestBase {
	...
	public DEV_TC_88_VerifyTheGetQouteFunctionality_Main(WebDriver driver) {
		try {
			this.driver = driver;
