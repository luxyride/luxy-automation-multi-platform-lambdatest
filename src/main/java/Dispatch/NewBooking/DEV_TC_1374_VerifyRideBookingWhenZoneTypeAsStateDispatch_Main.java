...
public class DEV_TC_1374_VerifyRideBookingWhenZoneTypeAsStateDispatch_Main extends TestBase {
	...
	public DEV_TC_1374_VerifyRideBookingWhenZoneTypeAsStateDispatch_Main(WebDriver driver) {
		try {
			this.driver = driver;
