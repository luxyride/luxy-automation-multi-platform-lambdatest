...
public class DEV_TC_1682_VerifyTheFunctionalityOfAvailableRideWhenItComesUnder10Hours_Main extends TestBase {
	...
	@FindBy(xpath = "(//tr[@class='rideUnderTenHr'])")
	WebElement redColor;
	...
	@FindBy(xpath = "(//span[normalize-space()='Rides'])[1]")
	WebElement affiliateridesTab;

	@FindBy(xpath = "(//span[normalize-space()='All'])[1]")
	WebElement affiliateallTab;

	@FindBy(xpath = "(//span[normalize-space()=\"Available\"])[1]")
	WebElement affiliateaUpComingTab;
	...
	Boolean todaysflag = true;

	public DEV_TC_1682_VerifyTheFunctionalityOfAvailableRideWhenItComesUnder10Hours_Main(WebDriver driver) {
		try {
			this.driver = driver;
	...
	public Map<String, Integer> enterTime(String scenario2, Boolean lessThan10hrs, Map<String, Integer> timeHours) {
		try {
	...
	public Boolean verifyRedColorBackGround(Boolean visibilityStatus2) {
		try {
			if (redColor.isDisplayed())
				visibilityStatus = true;
			else
				visibilityStatus = false;
		} catch (Exception ex) {
	...
	public void affiliatepasswordInput() {
		action = new Actions(driver);
		affiliatepasswordInput.sendKeys(prop.getProperty("affiliatePwd"));
	}
	...
	public void affiliateclickOnRides() {
		try {
			action = new Actions(driver);
			objTestBase.defaultWaitTime(1000);
			action.moveToElement(affiliateridesTab).click().build().perform();
			objTestBase.defaultWaitTime(1000);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	...
	public void affiliateclickOnAllTab() {
		try {
			action = new Actions(driver);
			objTestBase.defaultWaitTime(1000);
			action.moveToElement(affiliateallTab).click().build().perform();
			objTestBase.defaultWaitTime(1000);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	...
	public Boolean affiliatevisibilityOfLoggedinUser(Boolean visibilityStatus) {
		try {
			waitTimeForElement(affiliatesigninUser);
			if (affiliatesigninUser.isDisplayed()) {
				expected = affiliatesigninUser.getText();
				if (expected.toLowerCase().contains("welcome")) {
					visibilityStatus = true;
				} else {
					visibilityStatus = false;
	...
	public Boolean VisibilityOfAffiliateSearchInput(Boolean visibilityStatus2) {
	...
	public Boolean visibilityOfAlertMessage(Boolean visibilityStatus2) {
	...
	public void affiliateclickOnUpComingRides() {
		try {
			affiliateaUpComingTab.click();
		} catch (Exception e) {
			// TODO: handle exception
		}
	}

	public Boolean visibilityOfEditButtonRide(Boolean visibilityStatus2) {
	...
	public Boolean verifynormalColorBackGround(Boolean visibilityStatus) {
		try {
			visibilityStatus = !redColor.isDisplayed();
		} catch (Exception ex) {
			ex.printStackTrace();
		}
		return visibilityStatus;
