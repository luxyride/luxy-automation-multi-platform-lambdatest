...
public class DEV_TC_2030_VerifyUpdatedRideSearchFunctionalityForDispatchPortalWithSubstatus_Main extends TestBase {
	...
	@FindBy(xpath = "//th[@title='Sub Status']//following::tr//following::tr//td[5]")
	List<WebElement> subStatusType; // Available:
	...
	public DEV_TC_2030_VerifyUpdatedRideSearchFunctionalityForDispatchPortalWithSubstatus_Main(WebDriver driver) {
		try {
			this.driver = driver;
...
//					"2FA Validation Status for Script - " + getClass().getSimpleName() + " = " + visibilityStatus);
	...
	public Boolean verifySearchWithsubStatusType(String scenario, String pageName, Boolean visibilityStatus) {
		try {
			if (searchBox.size() != 0) {
				action = new Actions(driver);
				...
				if (subStatusType.size() != 0) {
					for (WebElement element : subStatusType) {
