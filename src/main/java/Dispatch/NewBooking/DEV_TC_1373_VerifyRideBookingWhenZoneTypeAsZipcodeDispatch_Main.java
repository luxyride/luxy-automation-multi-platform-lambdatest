...
public class DEV_TC_1373_VerifyRideBookingWhenZoneTypeAsZipcodeDispatch_Main extends TestBase {
	...
	public DEV_TC_1373_VerifyRideBookingWhenZoneTypeAsZipcodeDispatch_Main(WebDriver driver) {
		try {
			this.driver = driver;
...
//					"2FA Validation Status for Script - " + getClass().getSimpleName() + " = " + visibilityStatus);
	...
	public Map<String, Integer> enterTime(String scenario, Boolean lessThan24hrs, Map<String, Integer> timeHours) {
		try {
			...
			df.setTimeZone(TimeZone.getTimeZone(prop.getProperty("zoneIDZipcode")));
