...
public class DEV_TC_2344_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInDispatchPortal_Main
		extends TestBase {
	...
	public DEV_TC_2344_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInDispatchPortal_Main(
			WebDriver driver) {
		try {
			this.driver = driver;
...
//					"2FA Validation Status for Script - " + getClass().getSimpleName() + " = " + visibilityStatus);
	...
	public void enterLastName() {
		try {
			...
			primaryLastName.sendKeys(prop.getProperty("longCharecters"));
			String actualValue = primaryLastName.getAttribute("value");
			// Validation
