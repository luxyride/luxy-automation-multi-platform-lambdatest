...
public class DEV_TC_2007_VerifyOptInPinVerificationSecurityCheckboxAsUncheckedByDefaultInDispatchPortalCorporateRegistrationPage_Main extends TestBase {
	...
	public DEV_TC_2007_VerifyOptInPinVerificationSecurityCheckboxAsUncheckedByDefaultInDispatchPortalCorporateRegistrationPage_Main(WebDriver driver) {
		try {
			this.driver = driver;
	...
	public Boolean visibilityOfOPtInCheckBoxUncheckedByDefault(Boolean visibilityStatus) {
		try {
			if (optInCheckBox.isDisplayed())
				visibilityStatus = true;
			else
				visibilityStatus = false;
		} catch (Exception e) {
