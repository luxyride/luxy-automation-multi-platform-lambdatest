...
public class DEV_TC_1777_HourlyVerifyBookingARideInHourlyTabDispatchByEnablingSameAsPickUpAddressCheckbox_Main extends TestBase {
	...
	public DEV_TC_1777_HourlyVerifyBookingARideInHourlyTabDispatchByEnablingSameAsPickUpAddressCheckbox_Main(WebDriver driver) {
		try {
			this.driver = driver;
