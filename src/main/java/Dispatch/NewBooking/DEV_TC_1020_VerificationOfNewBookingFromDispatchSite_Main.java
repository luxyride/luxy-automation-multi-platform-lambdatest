...
public class DEV_TC_1020_VerificationOfNewBookingFromDispatchSite_Main extends TestBase {
	...
	public DEV_TC_1020_VerificationOfNewBookingFromDispatchSite_Main(WebDriver driver) {
		try {
			this.driver = driver;
