...
public class DEV_TC_1894_VerifyExtraStopIconUnderActionsInDispatchForTheRidesHavingExtraStops_Main extends TestBase {
	...
	public DEV_TC_1894_VerifyExtraStopIconUnderActionsInDispatchForTheRidesHavingExtraStops_Main(WebDriver driver) {
		try {
			this.driver = driver;
