...
public class DEV_TC_2043_VerifyRideReassignmentToDifferentCorporateAccountWhenARideIsBookedThroughDispatchPortal_Main extends TestBase {
	...
	WebElement conciergeRidesSection;
	
	@FindBy(xpath = "(//span[text() = 'All'])[1]")
	WebElement conciergeRidesTabAll;
	...
	WebElement corporateInput;
	
	@FindBy(xpath = "//button[@class='MuiButtonBase-root MuiButton-root MoveButton']")
	WebElement moveOption;
	
	@FindBy(xpath = "//div[normalize-space()='Ride successfully moved to corporate account']")
	...
	public DEV_TC_2043_VerifyRideReassignmentToDifferentCorporateAccountWhenARideIsBookedThroughDispatchPortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
	...
	public void searchBookingUserName() {
		try {
			action = new Actions(driver);
			action.moveToElement(searchBookingUser).click().sendKeys(prop.getProperty("conciergeadminMail")).build()
					.perform();
	...
	public String captureRideBookingIDs(Boolean visibilityStatus, String scenario, String tripID) {
		try {
			...
			if (expected.toLowerCase().contains("all")) {
				objTestBase.defaultWaitTime(500);
				action.moveToElement(searchUser).click().sendKeys(prop.getProperty("conciergeadminMail")).build()
						.perform();
				objTestBase.defaultWaitTime(3000);
				action.sendKeys(Keys.ENTER).build().perform();
				objTestBase.defaultWaitTime(1000);
	...
	public void clickOnMoveToCorporate() {
		try {
			moveBtn.click();
			objTestBase.defaultWaitTime(1000);
		} catch (Exception ex) {
	...
	public void enterCorporateName() {
		try {
			defaultWaitTime(1000);
			corporateInput.sendKeys(prop.getProperty("conciergeCompanyName"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public Boolean verifyConfirmationMsgafterRideMovingToCorporate(Boolean visibilityStatus) {
		try {
	...
	public void ConciergeEmailInput() {
		try {
			action = new Actions(driver);
	...
	public void ConciergepasswordInput() {
		try {
			action = new Actions(driver);
	...
	public void ConciergeClickRidesSection() {
		try {
			conciergeRidesSection.click();
			objTestBase.defaultWaitTime(1000);
			conciergeRidesTabAll.click();
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	}

	public void searchInput(String tripID) {
		try {
	...
	public Boolean visibilityOfSearchedRide(Boolean visibilityStatus) {
		try {
