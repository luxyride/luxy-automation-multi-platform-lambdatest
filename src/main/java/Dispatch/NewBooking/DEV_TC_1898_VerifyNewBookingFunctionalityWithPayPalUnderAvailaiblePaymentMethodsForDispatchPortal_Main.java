...
public class DEV_TC_1898_VerifyNewBookingFunctionalityWithPayPalUnderAvailaiblePaymentMethodsForDispatchPortal_Main extends TestBase {
	...
	public DEV_TC_1898_VerifyNewBookingFunctionalityWithPayPalUnderAvailaiblePaymentMethodsForDispatchPortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
...
//					"2FA Validation Status for Script - " + getClass().getSimpleName() + " = " + visibilityStatus);
	...
	public void clickOnpayingWithPayPalOption() {
		try {
