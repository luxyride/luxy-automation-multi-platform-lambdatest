...
public class DEV_TC_1408_VerifyDisplayingOfInternalNotesWhenInternalNotesIsAddedThroughRideSummarySectionExpandedViewInDispatchPortal_Main
		extends TestBase {
	...
	public DEV_TC_1408_VerifyDisplayingOfInternalNotesWhenInternalNotesIsAddedThroughRideSummarySectionExpandedViewInDispatchPortal_Main(
			WebDriver driver) {
		try {
			this.driver = driver;
