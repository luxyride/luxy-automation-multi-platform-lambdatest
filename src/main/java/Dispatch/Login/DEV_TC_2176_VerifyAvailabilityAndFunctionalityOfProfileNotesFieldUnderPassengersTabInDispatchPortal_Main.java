...
public class DEV_TC_2176_VerifyAvailabilityAndFunctionalityOfProfileNotesFieldUnderPassengersTabInDispatchPortal_Main extends TestBase {
	...
	public DEV_TC_2176_VerifyAvailabilityAndFunctionalityOfProfileNotesFieldUnderPassengersTabInDispatchPortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
...
//					"2FA Validation Status for Script - " + getClass().getSimpleName() + " = " + visibilityStatus);
	...
	public void enterAllRequiredFields() {
		try {
			...
			objTestBase.defaultWaitTime(2000);
			profileNotes.sendKeys(prop.getProperty("internalNotes"));
			objTestBase.defaultWaitTime(2000);
		} catch (Exception e) {
			e.printStackTrace();
		}
