...
public class DEV_TC_13_VerifyDisplayingOnDispatchSiteSigninPage_Main extends TestBase {
	WebDriver driver;
	Actions action;
	String expected;
	...
	public DEV_TC_13_VerifyDisplayingOnDispatchSiteSigninPage_Main(WebDriver driver) {
		try {
			this.driver = driver;
