...
public class DEV_TC_621_VerifytheCreationOfPromoCodeForMultipleUsesWithPromoType_Percent_Main extends TestBase {
	...
	public DEV_TC_621_VerifytheCreationOfPromoCodeForMultipleUsesWithPromoType_Percent_Main(WebDriver driver) {
		try {
			this.driver = driver;
...
//					"2FA Validation Status for Script - " + getClass().getSimpleName() + " = " + visibilityStatus);
	...
	public Boolean dispatchDeselectPromocodeAndSelectPercent(Boolean visibilityStatus) {
		try {
			action = new Actions(driver);
