...
public class DEV_TC_1554_VerifyFunctionalityOfAddingAdditionalAmountInAffiliatePaymentOfAffiliateTabInDispatch_Main
		extends TestBase {
	...
	public DEV_TC_1554_VerifyFunctionalityOfAddingAdditionalAmountInAffiliatePaymentOfAffiliateTabInDispatch_Main(
			WebDriver driver) {
		try {
			this.driver = driver;
