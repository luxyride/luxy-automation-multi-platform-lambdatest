...
public class DEV_TC_1557_VerifyTotalAffiliatePayoutInAffiliatePaymentsTabAfterAdditionalAmountAddingToAffiliateInDispatchPortal_Main
		extends TestBase {
	...
	public DEV_TC_1557_VerifyTotalAffiliatePayoutInAffiliatePaymentsTabAfterAdditionalAmountAddingToAffiliateInDispatchPortal_Main(
			WebDriver driver) {
		try {
			this.driver = driver;
