...
public class DEV_TC_1601_VerifyTheAvailabilityOfActiveAffiliatesAndInactiveAffiliatesTabsInManageAffiliatesPage_Main
		extends TestBase {
	...
	public DEV_TC_1601_VerifyTheAvailabilityOfActiveAffiliatesAndInactiveAffiliatesTabsInManageAffiliatesPage_Main(
			WebDriver driver) {
		try {
			this.driver = driver;
