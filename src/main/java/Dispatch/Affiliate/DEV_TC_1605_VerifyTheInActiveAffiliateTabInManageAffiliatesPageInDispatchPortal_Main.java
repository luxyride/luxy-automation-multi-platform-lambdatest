...
public class DEV_TC_1605_VerifyTheInActiveAffiliateTabInManageAffiliatesPageInDispatchPortal_Main extends TestBase {
	...
	public DEV_TC_1605_VerifyTheInActiveAffiliateTabInManageAffiliatesPageInDispatchPortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
...
//					"2FA Validation Status for Script - " + getClass().getSimpleName() + " = " + visibilityStatus);
	...
	public Boolean visibilityOfInActiveAffiliate(Boolean visibilityStatus) {
		try {
