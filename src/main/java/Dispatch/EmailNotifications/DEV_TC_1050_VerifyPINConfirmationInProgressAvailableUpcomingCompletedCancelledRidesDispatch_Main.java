...
public class DEV_TC_1050_VerifyPINConfirmationInProgressAvailableUpcomingCompletedCancelledRidesDispatch_Main
		extends TestBase {
	...
	public DEV_TC_1050_VerifyPINConfirmationInProgressAvailableUpcomingCompletedCancelledRidesDispatch_Main(
			WebDriver driver) {
		this.driver = driver;
