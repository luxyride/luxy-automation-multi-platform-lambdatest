...
public class DEV_TC_23_VerifytheAvailablityOfLogoutOption_Main extends TestBase {
	WebDriver driver;
	Actions action;
	String expected;
	...
	public DEV_TC_23_VerifytheAvailablityOfLogoutOption_Main(WebDriver driver) {
		try {
			this.driver = driver;
