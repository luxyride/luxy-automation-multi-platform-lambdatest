...
public class DEV_TC_1784_HourlyModifyAHourlyRideInConciergeWhichHasSameAsPickUpCheckBoxEnabled_Main extends TestBase {
	...
	public DEV_TC_1784_HourlyModifyAHourlyRideInConciergeWhichHasSameAsPickUpCheckBoxEnabled_Main(WebDriver driver) {
		try {
			this.driver = driver;
