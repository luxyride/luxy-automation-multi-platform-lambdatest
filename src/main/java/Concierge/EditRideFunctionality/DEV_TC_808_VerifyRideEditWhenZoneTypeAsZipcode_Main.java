...
public class DEV_TC_808_VerifyRideEditWhenZoneTypeAsZipcode_Main extends TestBase {
	...
	public DEV_TC_808_VerifyRideEditWhenZoneTypeAsZipcode_Main(WebDriver driver) {
		try {
			this.driver = driver;
