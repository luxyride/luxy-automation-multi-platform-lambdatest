...
public class DEV_TC_809_VerifyRideEditWhenZoneTypeAsCity_Main extends TestBase {
	...
	public DEV_TC_809_VerifyRideEditWhenZoneTypeAsCity_Main(WebDriver driver) {
		try {
			this.driver = driver;
