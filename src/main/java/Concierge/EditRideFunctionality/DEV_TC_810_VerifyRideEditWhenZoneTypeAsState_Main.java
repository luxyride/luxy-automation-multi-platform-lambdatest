...
public class DEV_TC_810_VerifyRideEditWhenZoneTypeAsState_Main extends TestBase {
	...
	public DEV_TC_810_VerifyRideEditWhenZoneTypeAsState_Main(WebDriver driver) {
		try {
			this.driver = driver;
