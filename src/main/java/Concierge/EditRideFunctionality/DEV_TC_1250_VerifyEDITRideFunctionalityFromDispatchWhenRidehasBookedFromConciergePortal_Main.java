...
public class DEV_TC_1250_VerifyEDITRideFunctionalityFromDispatchWhenRidehasBookedFromConciergePortal_Main
		extends TestBase {
	...
	public DEV_TC_1250_VerifyEDITRideFunctionalityFromDispatchWhenRidehasBookedFromConciergePortal_Main(
			WebDriver driver) {
		try {
			this.driver = driver;
