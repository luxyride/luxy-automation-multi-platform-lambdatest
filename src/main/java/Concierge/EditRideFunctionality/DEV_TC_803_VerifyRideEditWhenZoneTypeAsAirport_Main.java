...
public class DEV_TC_803_VerifyRideEditWhenZoneTypeAsAirport_Main extends TestBase {
	...
	public DEV_TC_803_VerifyRideEditWhenZoneTypeAsAirport_Main(WebDriver driver) {
		try {
			this.driver = driver;
