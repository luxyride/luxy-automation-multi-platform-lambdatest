...
public class DEV_TC_1498_VerifyDisplayingOfInternalNotesWhenInternalNotesIsAddedThroughRideSummarySectionExpandedViewInConciergePortal_Main
		extends TestBase {
	...
	public DEV_TC_1498_VerifyDisplayingOfInternalNotesWhenInternalNotesIsAddedThroughRideSummarySectionExpandedViewInConciergePortal_Main(
			WebDriver driver) {
		try {
			this.driver = driver;
