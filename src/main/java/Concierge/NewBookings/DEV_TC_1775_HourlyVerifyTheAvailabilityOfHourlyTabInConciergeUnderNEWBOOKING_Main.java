...
public class DEV_TC_1775_HourlyVerifyTheAvailabilityOfHourlyTabInConciergeUnderNEWBOOKING_Main extends TestBase {
	...
	public DEV_TC_1775_HourlyVerifyTheAvailabilityOfHourlyTabInConciergeUnderNEWBOOKING_Main(WebDriver driver) {
		try {
			this.driver = driver;
