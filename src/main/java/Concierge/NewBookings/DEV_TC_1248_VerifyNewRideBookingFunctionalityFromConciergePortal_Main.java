...
public class DEV_TC_1248_VerifyNewRideBookingFunctionalityFromConciergePortal_Main extends TestBase {
	...
	public DEV_TC_1248_VerifyNewRideBookingFunctionalityFromConciergePortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
