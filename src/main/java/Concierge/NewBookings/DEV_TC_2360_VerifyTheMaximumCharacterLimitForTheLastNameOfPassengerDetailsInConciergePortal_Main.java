...
public class DEV_TC_2360_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInConciergePortal_Main extends TestBase {
	...
	public DEV_TC_2360_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInConciergePortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
...
//					"2FA Validation Status for Script - " + getClass().getSimpleName() + " = " + visibilityStatus);
	...
	public void enterLastName() {
		try {
			...
			lastName.clear();
			defaultWaitTime(1000);
			lastName.sendKeys(prop.getProperty("longCharecters"));
			String actualValue = lastName.getAttribute("value");
			// Validation
			if (actualValue.length() <= 24) {
				System.out.println(
						"✅ PASS: Last Name is limited to 24 characters. Actual length: " + actualValue.length());
