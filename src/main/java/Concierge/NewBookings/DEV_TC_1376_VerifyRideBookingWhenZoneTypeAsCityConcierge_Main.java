...
public class DEV_TC_1376_VerifyRideBookingWhenZoneTypeAsCityConcierge_Main extends TestBase {
	...
	public DEV_TC_1376_VerifyRideBookingWhenZoneTypeAsCityConcierge_Main(WebDriver driver) {
		try {
			this.driver = driver;
