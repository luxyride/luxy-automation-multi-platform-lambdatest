...
public class DEV_TC_1889_VerifyTheAvailabilityOfPaymentMethodsInConciergePortal_Main extends TestBase {
	...
	public DEV_TC_1889_VerifyTheAvailabilityOfPaymentMethodsInConciergePortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
