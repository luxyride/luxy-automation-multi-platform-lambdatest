...
public class DEV_TC_1781_HourlyVerifyBookingARideinHourlyTabConciergeByDisablingSameAsPickupAddressCheckBox_Main extends TestBase {
	...
	public DEV_TC_1781_HourlyVerifyBookingARideinHourlyTabConciergeByDisablingSameAsPickupAddressCheckBox_Main(WebDriver driver) {
		try {
			this.driver = driver;
