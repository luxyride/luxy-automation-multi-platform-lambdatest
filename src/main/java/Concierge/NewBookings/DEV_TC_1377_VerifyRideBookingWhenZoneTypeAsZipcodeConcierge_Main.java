...
public class DEV_TC_1377_VerifyRideBookingWhenZoneTypeAsZipcodeConcierge_Main extends TestBase {
	...
	public DEV_TC_1377_VerifyRideBookingWhenZoneTypeAsZipcodeConcierge_Main(WebDriver driver) {
		try {
			this.driver = driver;
