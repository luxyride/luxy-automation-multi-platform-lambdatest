...
public class DEV_TC_1375_VerifyRideBookingWhenZoneTypeAsAirportConcierge_Main extends TestBase {
	...
	public DEV_TC_1375_VerifyRideBookingWhenZoneTypeAsAirportConcierge_Main(WebDriver driver) {
		try {
			this.driver = driver;
