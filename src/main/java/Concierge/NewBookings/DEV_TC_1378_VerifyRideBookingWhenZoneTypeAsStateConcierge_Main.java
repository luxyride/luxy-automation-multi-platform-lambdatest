...
public class DEV_TC_1378_VerifyRideBookingWhenZoneTypeAsStateConcierge_Main extends TestBase {
	...
	public DEV_TC_1378_VerifyRideBookingWhenZoneTypeAsStateConcierge_Main(WebDriver driver) {
		try {
			this.driver = driver;
