...
public class DEV_TC_1930_VerifyExtraStopIconUnderActionsInConciergeForTheRidesHavingExtraStops_Main extends TestBase {
	...
	public DEV_TC_1930_VerifyExtraStopIconUnderActionsInConciergeForTheRidesHavingExtraStops_Main(WebDriver driver) {
		try {
			this.driver = driver;
