...
public class DEV_TC_1416_VerifyTheFilteringOfConciergeRidesinConciergePortalUsingOriginatorType_Main extends TestBase {
	...
	public DEV_TC_1416_VerifyTheFilteringOfConciergeRidesinConciergePortalUsingOriginatorType_Main(WebDriver driver) {
		try {
			this.driver = driver;
	...
	public Boolean visibilityOfOriginatorDropSection(Boolean visibilityStatus) {
		try {
			...
			select.selectByValue("concierge");
			objTestBase.defaultWaitTime(3000);
	...
	public Boolean validateConciergerideDetails(Boolean visibilityStatus, String scenario) {
		try {
			if (sourceValue.size() != 0) {
				...
				conciergeTripIDsOriginator.put("concierge_" + scenario, tripID);
				...
				if (sourceValue.size() != 0) {
					...
					visibilityStatus = false;
					conciergeTripIDsOriginator.put("concierge_" + scenario, "No_Data");
				}
			} else {
