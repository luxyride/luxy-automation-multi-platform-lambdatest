...
public class DEV_TC_1490_VerifyTheAvailabilityOfAPSACheckBoxAndDocumentDownloadLinkInAffiliatePortalForTheNewAffiliatesCreatedThroughWebUserPortalOrDispatch_Main
		extends TestBase {
	WebDriver driver;
	Actions action;
	String expected;
	...
	public DEV_TC_1490_VerifyTheAvailabilityOfAPSACheckBoxAndDocumentDownloadLinkInAffiliatePortalForTheNewAffiliatesCreatedThroughWebUserPortalOrDispatch_Main(
			WebDriver driver) {
		this.driver = driver;
