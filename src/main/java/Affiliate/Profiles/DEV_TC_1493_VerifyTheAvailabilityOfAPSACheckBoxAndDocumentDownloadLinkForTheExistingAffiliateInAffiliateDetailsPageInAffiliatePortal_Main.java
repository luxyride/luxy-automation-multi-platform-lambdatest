...
public class DEV_TC_1493_VerifyTheAvailabilityOfAPSACheckBoxAndDocumentDownloadLinkForTheExistingAffiliateInAffiliateDetailsPageInAffiliatePortal_Main
		extends TestBase {
	WebDriver driver;
	Actions action;
	String expected;
	...
	public DEV_TC_1493_VerifyTheAvailabilityOfAPSACheckBoxAndDocumentDownloadLinkForTheExistingAffiliateInAffiliateDetailsPageInAffiliatePortal_Main(
			WebDriver driver) {
		this.driver = driver;
