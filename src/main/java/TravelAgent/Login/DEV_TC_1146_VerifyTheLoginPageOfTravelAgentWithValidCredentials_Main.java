...
public class DEV_TC_1146_VerifyTheLoginPageOfTravelAgentWithValidCredentials_Main extends TestBase {
	...
	public DEV_TC_1146_VerifyTheLoginPageOfTravelAgentWithValidCredentials_Main(WebDriver driver) {
		try {
			this.driver = driver;
