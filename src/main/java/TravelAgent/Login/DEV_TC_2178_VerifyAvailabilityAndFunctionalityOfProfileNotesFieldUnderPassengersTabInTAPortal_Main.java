...
public class DEV_TC_2178_VerifyAvailabilityAndFunctionalityOfProfileNotesFieldUnderPassengersTabInTAPortal_Main extends TestBase {
	...
	public DEV_TC_2178_VerifyAvailabilityAndFunctionalityOfProfileNotesFieldUnderPassengersTabInTAPortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
