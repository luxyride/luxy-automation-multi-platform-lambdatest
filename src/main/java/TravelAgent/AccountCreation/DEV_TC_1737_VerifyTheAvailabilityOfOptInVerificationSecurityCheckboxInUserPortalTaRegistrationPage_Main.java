...
public class DEV_TC_1737_VerifyTheAvailabilityOfOptInVerificationSecurityCheckboxInUserPortalTaRegistrationPage_Main
		extends TestBase {
	...
	public DEV_TC_1737_VerifyTheAvailabilityOfOptInVerificationSecurityCheckboxInUserPortalTaRegistrationPage_Main(
			WebDriver driver) {
		try {
			this.driver = driver;
