...
public class DEV_TC_1156_VerifyTheFunctionalityOfChangePassword_Main extends TestBase {
	WebDriver driver;
	Actions action;
	String expected;
	...
	public DEV_TC_1156_VerifyTheFunctionalityOfChangePassword_Main(WebDriver driver) {
		try {
			this.driver = driver;
	...
	public Boolean visibilityOfChangePwdBtn(Boolean visibilityStatus) {
		try {
