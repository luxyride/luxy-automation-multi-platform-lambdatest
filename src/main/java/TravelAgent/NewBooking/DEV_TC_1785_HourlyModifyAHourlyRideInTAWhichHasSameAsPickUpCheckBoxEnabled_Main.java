...
public class DEV_TC_1785_HourlyModifyAHourlyRideInTAWhichHasSameAsPickUpCheckBoxEnabled_Main extends TestBase {
	...
	public DEV_TC_1785_HourlyModifyAHourlyRideInTAWhichHasSameAsPickUpCheckBoxEnabled_Main(WebDriver driver) {
		try {
			this.driver = driver;
