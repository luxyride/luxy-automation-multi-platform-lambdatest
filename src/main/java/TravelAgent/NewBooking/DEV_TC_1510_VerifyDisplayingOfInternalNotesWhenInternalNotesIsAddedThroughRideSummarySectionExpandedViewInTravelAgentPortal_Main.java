...
public class DEV_TC_1510_VerifyDisplayingOfInternalNotesWhenInternalNotesIsAddedThroughRideSummarySectionExpandedViewInTravelAgentPortal_Main
		extends TestBase {
	...
	public DEV_TC_1510_VerifyDisplayingOfInternalNotesWhenInternalNotesIsAddedThroughRideSummarySectionExpandedViewInTravelAgentPortal_Main(
			WebDriver driver) {
		try {
			this.driver = driver;
	...
	public Boolean enterInternalNotes(Boolean visibilityStatus) {
		try {
			internalNotesText.click();
