...
public class DEV_TC_1228_VerifyRideBookedThroughTravelAgentIsListedInTravelAgentSiteUnderRIDEAllTab_Main
		extends TestBase {
	...
	public DEV_TC_1228_VerifyRideBookedThroughTravelAgentIsListedInTravelAgentSiteUnderRIDEAllTab_Main(
			WebDriver driver) {
		try {
			this.driver = driver;
	...
	public String verifyTripDetails(Boolean visibilityStatus, String tripID) {
		try {
			action = new Actions(driver);
			ridesTabAll.click();
