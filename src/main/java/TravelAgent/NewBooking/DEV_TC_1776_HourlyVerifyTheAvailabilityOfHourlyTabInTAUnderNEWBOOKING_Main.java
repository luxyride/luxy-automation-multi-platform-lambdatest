...
public class DEV_TC_1776_HourlyVerifyTheAvailabilityOfHourlyTabInTAUnderNEWBOOKING_Main extends TestBase {
	...
	public DEV_TC_1776_HourlyVerifyTheAvailabilityOfHourlyTabInTAUnderNEWBOOKING_Main(WebDriver driver) {
		try {
			this.driver = driver;
