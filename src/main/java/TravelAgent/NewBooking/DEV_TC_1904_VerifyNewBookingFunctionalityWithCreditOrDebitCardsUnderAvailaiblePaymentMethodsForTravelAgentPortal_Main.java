...
public class DEV_TC_1904_VerifyNewBookingFunctionalityWithCreditOrDebitCardsUnderAvailaiblePaymentMethodsForTravelAgentPortal_Main extends TestBase {
	...
	public DEV_TC_1904_VerifyNewBookingFunctionalityWithCreditOrDebitCardsUnderAvailaiblePaymentMethodsForTravelAgentPortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
