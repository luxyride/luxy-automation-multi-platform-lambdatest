...
public class DEV_TC_1812_VerifyRemoveOrderIdFromTAPortal_Main extends TestBase {
	...
	public DEV_TC_1812_VerifyRemoveOrderIdFromTAPortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
