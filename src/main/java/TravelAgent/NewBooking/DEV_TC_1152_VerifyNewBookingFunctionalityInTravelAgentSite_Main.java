...
public class DEV_TC_1152_VerifyNewBookingFunctionalityInTravelAgentSite_Main extends TestBase {
	...
	public DEV_TC_1152_VerifyNewBookingFunctionalityInTravelAgentSite_Main(WebDriver driver) {
		try {
			this.driver = driver;
