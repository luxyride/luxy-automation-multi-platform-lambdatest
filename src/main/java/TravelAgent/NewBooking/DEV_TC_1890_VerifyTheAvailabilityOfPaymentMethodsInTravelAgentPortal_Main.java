...
public class DEV_TC_1890_VerifyTheAvailabilityOfPaymentMethodsInTravelAgentPortal_Main extends TestBase {
	...
	public DEV_TC_1890_VerifyTheAvailabilityOfPaymentMethodsInTravelAgentPortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
