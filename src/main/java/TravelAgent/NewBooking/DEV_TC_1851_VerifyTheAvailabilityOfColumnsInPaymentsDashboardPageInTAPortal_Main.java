...
public class DEV_TC_1851_VerifyTheAvailabilityOfColumnsInPaymentsDashboardPageInTAPortal_Main extends TestBase {
	...
	public DEV_TC_1851_VerifyTheAvailabilityOfColumnsInPaymentsDashboardPageInTAPortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
