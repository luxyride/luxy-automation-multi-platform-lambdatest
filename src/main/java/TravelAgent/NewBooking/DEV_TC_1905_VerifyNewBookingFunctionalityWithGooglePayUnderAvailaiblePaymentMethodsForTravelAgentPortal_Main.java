...
public class DEV_TC_1905_VerifyNewBookingFunctionalityWithGooglePayUnderAvailaiblePaymentMethodsForTravelAgentPortal_Main
		extends TestBase {
	...
	public DEV_TC_1905_VerifyNewBookingFunctionalityWithGooglePayUnderAvailaiblePaymentMethodsForTravelAgentPortal_Main(
			WebDriver driver) {
		try {
			this.driver = driver;
