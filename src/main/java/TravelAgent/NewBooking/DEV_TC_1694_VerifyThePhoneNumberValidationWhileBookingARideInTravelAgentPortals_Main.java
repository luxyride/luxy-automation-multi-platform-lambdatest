...
public class DEV_TC_1694_VerifyThePhoneNumberValidationWhileBookingARideInTravelAgentPortals_Main extends TestBase {
	...
	public DEV_TC_1694_VerifyThePhoneNumberValidationWhileBookingARideInTravelAgentPortals_Main(WebDriver driver) {
		try {
			this.driver = driver;
