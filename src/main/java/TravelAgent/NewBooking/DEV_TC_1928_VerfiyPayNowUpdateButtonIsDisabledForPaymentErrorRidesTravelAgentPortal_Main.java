...
public class DEV_TC_1928_VerfiyPayNowUpdateButtonIsDisabledForPaymentErrorRidesTravelAgentPortal_Main extends TestBase {
	...
	public DEV_TC_1928_VerfiyPayNowUpdateButtonIsDisabledForPaymentErrorRidesTravelAgentPortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
