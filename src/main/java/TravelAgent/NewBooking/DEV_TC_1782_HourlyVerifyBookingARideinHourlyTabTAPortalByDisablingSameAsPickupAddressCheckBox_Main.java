...
public class DEV_TC_1782_HourlyVerifyBookingARideinHourlyTabTAPortalByDisablingSameAsPickupAddressCheckBox_Main extends TestBase {
	...
	public DEV_TC_1782_HourlyVerifyBookingARideinHourlyTabTAPortalByDisablingSameAsPickupAddressCheckBox_Main(WebDriver driver) {
		try {
			this.driver = driver;
