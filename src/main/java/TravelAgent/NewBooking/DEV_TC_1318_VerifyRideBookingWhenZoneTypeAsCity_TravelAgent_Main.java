...
public class DEV_TC_1318_VerifyRideBookingWhenZoneTypeAsCity_TravelAgent_Main extends TestBase {
	...
	public DEV_TC_1318_VerifyRideBookingWhenZoneTypeAsCity_TravelAgent_Main(WebDriver driver) {
		try {
			this.driver = driver;
	...
	public void addDispatchFromAddress() {
		try {
			...
			objTestBase.defaultWaitTime(1000);
			taFromAddress.sendKeys(prop.getProperty("zoneTypeCityFromAddress"));
			objTestBase.defaultWaitTime(3000);
			action.sendKeys(Keys.DOWN).build().perform();
			objTestBase.defaultWaitTime(1000);
			action.sendKeys(Keys.ENTER).build().perform();
	...
	public void addDispatchToAddress() {
		try {
			action = new Actions(driver);
			taToAddress.sendKeys(prop.getProperty("zoneTypeCityToAddressPositive"));
			objTestBase.defaultWaitTime(3000);
			action.sendKeys(Keys.DOWN).build().perform();
			objTestBase.defaultWaitTime(1000);
			action.sendKeys(Keys.ENTER).build().perform();
