...
public class DEV_TC_1946_VerifyRemoveSortingFunctionsColumnsFromAllPagesInTravelAgentPortal_Main extends TestBase {
	...
	public DEV_TC_1946_VerifyRemoveSortingFunctionsColumnsFromAllPagesInTravelAgentPortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
