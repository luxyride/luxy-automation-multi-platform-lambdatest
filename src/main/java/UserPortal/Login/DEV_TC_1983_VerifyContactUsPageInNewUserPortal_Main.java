...
public class DEV_TC_1983_VerifyContactUsPageInNewUserPortal_Main extends TestBase {
	...
	public DEV_TC_1983_VerifyContactUsPageInNewUserPortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
