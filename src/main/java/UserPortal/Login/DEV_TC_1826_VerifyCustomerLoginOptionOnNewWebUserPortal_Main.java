...
public class DEV_TC_1826_VerifyCustomerLoginOptionOnNewWebUserPortal_Main extends TestBase {
	...
	public DEV_TC_1826_VerifyCustomerLoginOptionOnNewWebUserPortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
