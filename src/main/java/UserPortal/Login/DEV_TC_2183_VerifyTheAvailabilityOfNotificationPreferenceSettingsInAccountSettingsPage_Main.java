...
public class DEV_TC_2183_VerifyTheAvailabilityOfNotificationPreferenceSettingsInAccountSettingsPage_Main extends TestBase {
	...
	public DEV_TC_2183_VerifyTheAvailabilityOfNotificationPreferenceSettingsInAccountSettingsPage_Main(WebDriver driver) {
		try {
			this.driver = driver;
