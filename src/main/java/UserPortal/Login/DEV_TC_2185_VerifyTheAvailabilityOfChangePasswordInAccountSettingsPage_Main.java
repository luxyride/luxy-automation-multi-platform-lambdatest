...
public class DEV_TC_2185_VerifyTheAvailabilityOfChangePasswordInAccountSettingsPage_Main extends TestBase {
	...
	public DEV_TC_2185_VerifyTheAvailabilityOfChangePasswordInAccountSettingsPage_Main(WebDriver driver) {
		try {
			this.driver = driver;
