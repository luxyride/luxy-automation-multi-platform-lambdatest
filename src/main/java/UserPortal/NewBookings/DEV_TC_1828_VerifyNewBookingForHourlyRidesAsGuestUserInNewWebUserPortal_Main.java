...
public class DEV_TC_1828_VerifyNewBookingForHourlyRidesAsGuestUserInNewWebUserPortal_Main extends TestBase {
	...
	public DEV_TC_1828_VerifyNewBookingForHourlyRidesAsGuestUserInNewWebUserPortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
	...
	public void selectDropdown() {
		try {
			action = new Actions(driver);
			JavascriptExecutor js = (JavascriptExecutor) driver;
			js.executeScript("arguments[0].scrollIntoView(true);", hourly);
			js.executeScript("window.scrollBy(0,-100)", "");
