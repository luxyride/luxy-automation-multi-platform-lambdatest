...
public class DEV_TC_1827_VerifyNewBookingForIndividualRidesAsGuestUserInNewWebUserPortal_Main extends TestBase {
	...
	public DEV_TC_1827_VerifyNewBookingForIndividualRidesAsGuestUserInNewWebUserPortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
