...
public class DEV_TC_2345_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInWebUserPortal_Main
		extends TestBase {
	...
	public DEV_TC_2345_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInWebUserPortal_Main(
			WebDriver driver) {
		try {
			this.driver = driver;
