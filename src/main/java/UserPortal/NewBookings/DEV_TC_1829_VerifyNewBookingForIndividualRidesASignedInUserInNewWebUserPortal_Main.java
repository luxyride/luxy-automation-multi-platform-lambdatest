...
public class DEV_TC_1829_VerifyNewBookingForIndividualRidesASignedInUserInNewWebUserPortal_Main extends TestBase {
	...
	public DEV_TC_1829_VerifyNewBookingForIndividualRidesASignedInUserInNewWebUserPortal_Main(WebDriver driver) {
		try {
			this.driver = driver;
