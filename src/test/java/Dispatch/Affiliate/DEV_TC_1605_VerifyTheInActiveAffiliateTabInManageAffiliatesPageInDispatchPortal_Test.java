...
public class DEV_TC_1605_VerifyTheInActiveAffiliateTabInManageAffiliatesPageInDispatchPortal_Test extends TestBase {
	...
	DEV_TC_1605_VerifyTheInActiveAffiliateTabInManageAffiliatesPageInDispatchPortal_Main objVerifySighninMain;
	DEV_TC_1605_VerifyTheInActiveAffiliateTabInManageAffiliatesPageInDispatchPortal_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1605_VerifyTheInActiveAffiliateTabInManageAffiliatesPageInDispatchPortal_Main(driver);
			objVerifySighninTest = new DEV_TC_1605_VerifyTheInActiveAffiliateTabInManageAffiliatesPageInDispatchPortal_Test();
			objTestBase = new TestBase();
			...
			if (testStatus == "PASSED") {
				...
				visibilityStatus = objVerifySighninMain.visibilityOfInActiveAffiliate(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					if (localExecutionFlag == true)	objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);	else	lambdaTestStatusUpdate("passed", testStep);
					testStatus = "PASSED";
				} else {
