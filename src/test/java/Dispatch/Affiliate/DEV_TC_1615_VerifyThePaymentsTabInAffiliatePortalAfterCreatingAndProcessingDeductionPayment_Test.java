...
public class DEV_TC_1615_VerifyThePaymentsTabInAffiliatePortalAfterCreatingAndProcessingDeductionPayment_Test
		extends TestBase {
	...
	DEV_TC_1615_VerifyThePaymentsTabInAffiliatePortalAfterCreatingAndProcessingDeductionPayment_Main objVerifySighninMain;
	DEV_TC_1615_VerifyThePaymentsTabInAffiliatePortalAfterCreatingAndProcessingDeductionPayment_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1615_VerifyThePaymentsTabInAffiliatePortalAfterCreatingAndProcessingDeductionPayment_Main(
					driver);
			objVerifySighninTest = new DEV_TC_1615_VerifyThePaymentsTabInAffiliatePortalAfterCreatingAndProcessingDeductionPayment_Test();
			objTestBase = new TestBase();
