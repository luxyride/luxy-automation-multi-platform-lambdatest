...
public class DEV_TC_1554_VerifyFunctionalityOfAddingAdditionalAmountInAffiliatePaymentOfAffiliateTabInDispatch_Test
		extends TestBase {
	...
	DEV_TC_1554_VerifyFunctionalityOfAddingAdditionalAmountInAffiliatePaymentOfAffiliateTabInDispatch_Main objVerifySighninMain;
	DEV_TC_1554_VerifyFunctionalityOfAddingAdditionalAmountInAffiliatePaymentOfAffiliateTabInDispatch_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1554_VerifyFunctionalityOfAddingAdditionalAmountInAffiliatePaymentOfAffiliateTabInDispatch_Main(
					driver);
			objVerifySighninTest = new DEV_TC_1554_VerifyFunctionalityOfAddingAdditionalAmountInAffiliatePaymentOfAffiliateTabInDispatch_Test();
			objTestBase = new TestBase();
