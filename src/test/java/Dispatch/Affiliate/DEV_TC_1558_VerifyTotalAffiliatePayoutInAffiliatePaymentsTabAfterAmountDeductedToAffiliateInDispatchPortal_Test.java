...
public class DEV_TC_1558_VerifyTotalAffiliatePayoutInAffiliatePaymentsTabAfterAmountDeductedToAffiliateInDispatchPortal_Test
		extends TestBase {
	...
	DEV_TC_1558_VerifyTotalAffiliatePayoutInAffiliatePaymentsTabAfterAmountDeductedToAffiliateInDispatchPortal_Main objVerifySighninMain;
	DEV_TC_1558_VerifyTotalAffiliatePayoutInAffiliatePaymentsTabAfterAmountDeductedToAffiliateInDispatchPortal_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1558_VerifyTotalAffiliatePayoutInAffiliatePaymentsTabAfterAmountDeductedToAffiliateInDispatchPortal_Main(
					driver);
			objVerifySighninTest = new DEV_TC_1558_VerifyTotalAffiliatePayoutInAffiliatePaymentsTabAfterAmountDeductedToAffiliateInDispatchPortal_Test();
			objTestBase = new TestBase();
