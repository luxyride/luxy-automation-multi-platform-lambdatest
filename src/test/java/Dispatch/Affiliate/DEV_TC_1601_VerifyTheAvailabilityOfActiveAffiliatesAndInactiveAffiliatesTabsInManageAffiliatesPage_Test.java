...
public class DEV_TC_1601_VerifyTheAvailabilityOfActiveAffiliatesAndInactiveAffiliatesTabsInManageAffiliatesPage_Test extends TestBase {
	...
	DEV_TC_1601_VerifyTheAvailabilityOfActiveAffiliatesAndInactiveAffiliatesTabsInManageAffiliatesPage_Main objVerifySighninMain;
	DEV_TC_1601_VerifyTheAvailabilityOfActiveAffiliatesAndInactiveAffiliatesTabsInManageAffiliatesPage_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1601_VerifyTheAvailabilityOfActiveAffiliatesAndInactiveAffiliatesTabsInManageAffiliatesPage_Main(driver);
			objVerifySighninTest = new DEV_TC_1601_VerifyTheAvailabilityOfActiveAffiliatesAndInactiveAffiliatesTabsInManageAffiliatesPage_Test();
			objTestBase = new TestBase();
			...
			if (testStatus == "PASSED") {
				...
				testStep = "verify the availability of search bar /  Add affiliate Button in manage affiliate page";
				visibilityStatus = objVerifySighninMain.visibilityOfSearchBarandAddAffiliateBtn(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					if (localExecutionFlag == true)	objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);	else	lambdaTestStatusUpdate("passed", testStep);
					testStatus = "PASSED";
				} else {
