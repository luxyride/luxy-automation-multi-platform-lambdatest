...
public class DEV_TC_1823_VerifyTheFunctionalityOfActiveAInactiveCoverageZonesInDispatchPortalUnderAffiliate_Test
		extends TestBase {
	...
	DEV_TC_1823_VerifyTheFunctionalityOfActiveAInactiveCoverageZonesInDispatchPortalUnderAffiliate_Main objVerifySighninMain;
	DEV_TC_1823_VerifyTheFunctionalityOfActiveAInactiveCoverageZonesInDispatchPortalUnderAffiliate_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1823_VerifyTheFunctionalityOfActiveAInactiveCoverageZonesInDispatchPortalUnderAffiliate_Main(
					driver);
			objVerifySighninTest = new DEV_TC_1823_VerifyTheFunctionalityOfActiveAInactiveCoverageZonesInDispatchPortalUnderAffiliate_Test();
			objTestBase = new TestBase();
			...
			if (testStatus == "PASSED") {
				...
				if (testStatus == "PASSED") {
					testStep = "Verification of Affiliate EDIT Page Navigation";
