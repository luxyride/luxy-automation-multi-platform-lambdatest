...
public class DEV_TC_1603_VerifyTheActiveAffiliateTabInManageAffiliatesPageInDispatchPortal_Test extends TestBase {
	...
	DEV_TC_1603_VerifyTheActiveAffiliateTabInManageAffiliatesPageInDispatchPortal_Main objVerifySighninMain;
	DEV_TC_1603_VerifyTheActiveAffiliateTabInManageAffiliatesPageInDispatchPortal_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1603_VerifyTheActiveAffiliateTabInManageAffiliatesPageInDispatchPortal_Main(driver);
			objVerifySighninTest = new DEV_TC_1603_VerifyTheActiveAffiliateTabInManageAffiliatesPageInDispatchPortal_Test();
			objTestBase = new TestBase();
