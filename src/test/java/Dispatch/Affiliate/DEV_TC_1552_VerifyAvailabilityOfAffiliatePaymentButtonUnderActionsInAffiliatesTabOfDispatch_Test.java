...
public class DEV_TC_1552_VerifyAvailabilityOfAffiliatePaymentButtonUnderActionsInAffiliatesTabOfDispatch_Test
		extends TestBase {
	...
	DEV_TC_1552_VerifyAvailabilityOfAffiliatePaymentButtonUnderActionsInAffiliatesTabOfDispatch_Main objVerifySighninMain;
	DEV_TC_1552_VerifyAvailabilityOfAffiliatePaymentButtonUnderActionsInAffiliatesTabOfDispatch_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1552_VerifyAvailabilityOfAffiliatePaymentButtonUnderActionsInAffiliatesTabOfDispatch_Main(
					driver);
			objVerifySighninTest = new DEV_TC_1552_VerifyAvailabilityOfAffiliatePaymentButtonUnderActionsInAffiliatesTabOfDispatch_Test();
			objTestBase = new TestBase();
