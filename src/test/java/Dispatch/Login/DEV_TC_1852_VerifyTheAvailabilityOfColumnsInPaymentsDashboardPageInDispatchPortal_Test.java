...
public class DEV_TC_1852_VerifyTheAvailabilityOfColumnsInPaymentsDashboardPageInDispatchPortal_Test extends TestBase {
	...
	DEV_TC_1852_VerifyTheAvailabilityOfColumnsInPaymentsDashboardPageInDispatchPortal_Main objVerifySighninMain;
	DEV_TC_1852_VerifyTheAvailabilityOfColumnsInPaymentsDashboardPageInDispatchPortal_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1852_VerifyTheAvailabilityOfColumnsInPaymentsDashboardPageInDispatchPortal_Main(
					driver);
			objVerifySighninTest = new DEV_TC_1852_VerifyTheAvailabilityOfColumnsInPaymentsDashboardPageInDispatchPortal_Test();
			objTestBase = new TestBase();
			...
			visibilityStatus = objVerifySighninMain.veriftTheColumnsAvailableInPaymentsDashBoard(visibilityStatus);
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)
					objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
				else
