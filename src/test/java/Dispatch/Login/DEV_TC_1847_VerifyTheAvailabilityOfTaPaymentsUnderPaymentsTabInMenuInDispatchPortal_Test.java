...
public class DEV_TC_1847_VerifyTheAvailabilityOfTaPaymentsUnderPaymentsTabInMenuInDispatchPortal_Test extends TestBase {
	...
	DEV_TC_1847_VerifyTheAvailabilityOfTaPaymentsUnderPaymentsTabInMenuInDispatchPortal_Main objVerifySighninMain;
	DEV_TC_1847_VerifyTheAvailabilityOfTaPaymentsUnderPaymentsTabInMenuInDispatchPortal_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1847_VerifyTheAvailabilityOfTaPaymentsUnderPaymentsTabInMenuInDispatchPortal_Main(
					driver);
			objVerifySighninTest = new DEV_TC_1847_VerifyTheAvailabilityOfTaPaymentsUnderPaymentsTabInMenuInDispatchPortal_Test();
			objTestBase = new TestBase();
