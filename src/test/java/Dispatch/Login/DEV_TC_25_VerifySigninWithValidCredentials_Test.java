...
public class DEV_TC_25_VerifySigninWithValidCredentials_Test extends TestBase {
	...
	DEV_TC_25_VerifySigninWithValidCredentials_Main objVerifySighninMain;
	DEV_TC_25_VerifySigninWithValidCredentials_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_25_VerifySigninWithValidCredentials_Main(driver);
			objVerifySighninTest = new DEV_TC_25_VerifySigninWithValidCredentials_Test();
			objTestBase = new TestBase();
