...
public class DEV_TC_1395_VerifyTheAvailabilityOfMONTHLYINVOICEOptionInMenuInDispatch_Test extends TestBase {
	...
	DEV_TC_1395_VerifyTheAvailabilityOfMONTHLYINVOICEOptionInMenuInDispatch_Main objVerifyLogout_Main;
	DEV_TC_1395_VerifyTheAvailabilityOfMONTHLYINVOICEOptionInMenuInDispatch_Test objVerifyLogout_Test;
	...
	public void VerifyUserShouldNotLogoutAutomaticallyWhenReloadsTheDispatchPage() throws Exception {
		...
		try {
			...
			objVerifyLogout_Main = new DEV_TC_1395_VerifyTheAvailabilityOfMONTHLYINVOICEOptionInMenuInDispatch_Main(
					driver);
			objVerifyLogout_Test = new DEV_TC_1395_VerifyTheAvailabilityOfMONTHLYINVOICEOptionInMenuInDispatch_Test();
			objTestBase = new TestBase();
