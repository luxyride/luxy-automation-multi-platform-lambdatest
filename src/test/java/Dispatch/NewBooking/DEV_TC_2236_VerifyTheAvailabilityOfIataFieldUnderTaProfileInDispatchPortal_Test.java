...
public class DEV_TC_2236_VerifyTheAvailabilityOfIataFieldUnderTaProfileInDispatchPortal_Test extends TestBase {
	...
	DEV_TC_2236_VerifyTheAvailabilityOfIataFieldUnderTaProfileInDispatchPortal_Main objVerifySighninMain;
	DEV_TC_2236_VerifyTheAvailabilityOfIataFieldUnderTaProfileInDispatchPortal_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_2236_VerifyTheAvailabilityOfIataFieldUnderTaProfileInDispatchPortal_Main(
					driver);
			objVerifySighninTest = new DEV_TC_2236_VerifyTheAvailabilityOfIataFieldUnderTaProfileInDispatchPortal_Test();
			objTestBase = new TestBase();
			...
			if (testStatus == "PASSED") {
				...
				objTestBase.defaultWaitTime(2000);
				objVerifySighninMain.clickTravelArranger2();
				objTestBase.defaultWaitTime(2000);
				objVerifySighninMain.clickAddTravelArrangerBtn();
				objTestBase.defaultWaitTime(2000);

				testStep = "visibility of IATA Field in TA Registration Page";
