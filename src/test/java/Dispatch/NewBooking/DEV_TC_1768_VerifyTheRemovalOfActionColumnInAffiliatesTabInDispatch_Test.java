...
public class DEV_TC_1768_VerifyTheRemovalOfActionColumnInAffiliatesTabInDispatch_Test extends TestBase {
	...
	DEV_TC_1768_VerifyTheRemovalOfActionColumnInAffiliatesTabInDispatch_Main objVerifySighninMain;
	DEV_TC_1768_VerifyTheRemovalOfActionColumnInAffiliatesTabInDispatch_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1768_VerifyTheRemovalOfActionColumnInAffiliatesTabInDispatch_Main(driver);
			objVerifySighninTest = new DEV_TC_1768_VerifyTheRemovalOfActionColumnInAffiliatesTabInDispatch_Test();
			objTestBase = new TestBase();
			...
			if (testStatus == "PASSED") {
				...
				objTestBase.defaultWaitTime(2000);
				objVerifySighninMain.clickOnAffiliates();
				objTestBase.defaultWaitTime(2000);
				...
				testStep = "verify of Deactivate option should Not appear ";
				visibilityStatus = objVerifySighninMain.verifyDeactivateOptionShouldNotAppear(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					if (localExecutionFlag == true)
						objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
					else
