...
public class DEV_TC_1688_VerifyTheAvailabilityOfColumnsInDispatchPortalForSpecialEvents_Test extends TestBase {
	...
	DEV_TC_1688_VerifyTheAvailabilityOfColumnsInDispatchPortalForSpecialEvents_Main objVerifylogoutMain;
	DEV_TC_1688_VerifyTheAvailabilityOfColumnsInDispatchPortalForSpecialEvents_Test objVerifylogoutTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		try {
			...
			objVerifylogoutMain = new DEV_TC_1688_VerifyTheAvailabilityOfColumnsInDispatchPortalForSpecialEvents_Main(
					driver);
			objVerifylogoutTest = new DEV_TC_1688_VerifyTheAvailabilityOfColumnsInDispatchPortalForSpecialEvents_Test();
			objTestBase = new TestBase();
			...
			objTestBase.defaultWaitTime(1000);
			objVerifylogoutMain.clickspecialEventsTab();
			objTestBase.defaultWaitTime(3000);

			testStep = "Verify availability of columns in special events tab ";
			visibilityStatus = objVerifylogoutMain.visibilityOfcolumnsInSpecialEventsPage(visibilityStatus);
			objTestBase.defaultWaitTime(2000);
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)	objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);	else	lambdaTestStatusUpdate("passed", testStep);
				testStatus = "PASSED";
