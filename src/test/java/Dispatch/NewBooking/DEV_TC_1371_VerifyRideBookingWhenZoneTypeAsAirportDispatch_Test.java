...
public class DEV_TC_1371_VerifyRideBookingWhenZoneTypeAsAirportDispatch_Test extends TestBase {
	...
	DEV_TC_1371_VerifyRideBookingWhenZoneTypeAsAirportDispatch_Main objVerifyEditRidesZone_Main;
	DEV_TC_1371_VerifyRideBookingWhenZoneTypeAsAirportDispatch_Test objVerifyEditRidesZone_Test;
	...
	public void verifyRideEditWhenZoneTypeAsAirport() throws Exception {
		try {
			action = new Actions(driver);
			objVerifyEditRidesZone_Main = new DEV_TC_1371_VerifyRideBookingWhenZoneTypeAsAirportDispatch_Main(driver);
			objVerifyEditRidesZone_Test = new DEV_TC_1371_VerifyRideBookingWhenZoneTypeAsAirportDispatch_Test();
			objTestBase = new TestBase();
			...
			if (testStatus == "PASSED") {
				...
				objVerifyEditRidesZone_Main.searchBookingUserName();
				objTestBase.defaultWaitTime(1000);
				objVerifyEditRidesZone_Main.clickcheckbox();
				objTestBase.defaultWaitTime(2000);
				...
				objTestBase.defaultWaitTime(1000);
				objVerifyEditRidesZone_Main.enterFlightNumber();
				objTestBase.defaultWaitTime(1000);
				...
				objTestBase.defaultWaitTime(2000);
				objVerifyEditRidesZone_Main.enterPromocode(scenario);
				objTestBase.defaultWaitTime(2000);
				objVerifyEditRidesZone_Main.clickonPromocodeApply();
				objTestBase.defaultWaitTime(2000);
