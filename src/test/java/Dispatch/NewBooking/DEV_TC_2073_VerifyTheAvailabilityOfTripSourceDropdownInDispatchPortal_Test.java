...
public class DEV_TC_2073_VerifyTheAvailabilityOfTripSourceDropdownInDispatchPortal_Test extends TestBase {
	...
	DEV_TC_2073_VerifyTheAvailabilityOfTripSourceDropdownInDispatchPortal_Main objVerifySighninMain;
	DEV_TC_2073_VerifyTheAvailabilityOfTripSourceDropdownInDispatchPortal_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_2073_VerifyTheAvailabilityOfTripSourceDropdownInDispatchPortal_Main(
					driver);
			objVerifySighninTest = new DEV_TC_2073_VerifyTheAvailabilityOfTripSourceDropdownInDispatchPortal_Test();
			objTestBase = new TestBase();
