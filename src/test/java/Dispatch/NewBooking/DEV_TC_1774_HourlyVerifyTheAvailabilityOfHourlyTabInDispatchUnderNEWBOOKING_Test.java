...
public class DEV_TC_1774_HourlyVerifyTheAvailabilityOfHourlyTabInDispatchUnderNEWBOOKING_Test extends TestBase {
	...
	DEV_TC_1774_HourlyVerifyTheAvailabilityOfHourlyTabInDispatchUnderNEWBOOKING_Main objVerifySighninMain;
	DEV_TC_1774_HourlyVerifyTheAvailabilityOfHourlyTabInDispatchUnderNEWBOOKING_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1774_HourlyVerifyTheAvailabilityOfHourlyTabInDispatchUnderNEWBOOKING_Main(driver);
			objVerifySighninTest = new DEV_TC_1774_HourlyVerifyTheAvailabilityOfHourlyTabInDispatchUnderNEWBOOKING_Test();
			objTestBase = new TestBase();
