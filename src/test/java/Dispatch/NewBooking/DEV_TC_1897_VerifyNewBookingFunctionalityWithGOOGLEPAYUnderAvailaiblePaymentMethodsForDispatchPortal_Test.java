...
public class DEV_TC_1897_VerifyNewBookingFunctionalityWithGOOGLEPAYUnderAvailaiblePaymentMethodsForDispatchPortal_Test
		extends TestBase {
	...
	DEV_TC_1897_VerifyNewBookingFunctionalityWithGOOGLEPAYUnderAvailaiblePaymentMethodsForDispatchPortal_Main objVerifyNewBookingDispatchMain;
	DEV_TC_1897_VerifyNewBookingFunctionalityWithGOOGLEPAYUnderAvailaiblePaymentMethodsForDispatchPortal_Test objVerifyNewBookingDispatchTest;
	...
	public void verificationOfNewBookingFromDispatchSite() throws Exception {
		...
		try {
			...
			objVerifyNewBookingDispatchMain = new DEV_TC_1897_VerifyNewBookingFunctionalityWithGOOGLEPAYUnderAvailaiblePaymentMethodsForDispatchPortal_Main(
					driver);
			objVerifyNewBookingDispatchTest = new DEV_TC_1897_VerifyNewBookingFunctionalityWithGOOGLEPAYUnderAvailaiblePaymentMethodsForDispatchPortal_Test();
			objTestBase = new TestBase();
	...
	public String vechileBooking(String scenario, String testStatus) throws Exception {
		try {
			...
			visibilityStatus = objVerifyNewBookingDispatchMain.verifyGooglePayOptionVisibility(visibilityStatus);
			objTestBase.defaultWaitTime(2000);
			
			String parentWindow = driver.getWindowHandle();
			objTestBase.defaultWaitTime(1000);
			
			objVerifyNewBookingDispatchMain.clickOnpayingWithgooglePayOption();
			objTestBase.defaultWaitTime(10000);
			
			testStep = "Verification of Google Payment Continue popup";
			visibilityStatus = objVerifyNewBookingDispatchMain.verifyContinueBtnVisibility(parentWindow, visibilityStatus);
			objTestBase.defaultWaitTime(2000);
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)
					objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
			...
			objVerifyNewBookingDispatchMain.clickOnContinueButton();
			objTestBase.defaultWaitTime(10000);
