...
public class DEV_TC_1374_VerifyRideBookingWhenZoneTypeAsStateDispatch_Test extends TestBase {
	...
	DEV_TC_1374_VerifyRideBookingWhenZoneTypeAsStateDispatch_Main objVerifyBufferTime_Main;
	DEV_TC_1374_VerifyRideBookingWhenZoneTypeAsStateDispatch_Test objVerifyBufferTime_Test;
	...
	public void verifyRideEditWhenZoneTypeAsState() throws Exception {
		try {
			...
			objVerifyBufferTime_Main = new DEV_TC_1374_VerifyRideBookingWhenZoneTypeAsStateDispatch_Main(driver);
			objVerifyBufferTime_Test = new DEV_TC_1374_VerifyRideBookingWhenZoneTypeAsStateDispatch_Test();
			objTestBase = new TestBase();
