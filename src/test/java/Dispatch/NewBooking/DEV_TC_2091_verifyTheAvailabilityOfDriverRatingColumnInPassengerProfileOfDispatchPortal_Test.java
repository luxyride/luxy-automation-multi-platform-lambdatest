...
public class DEV_TC_2091_verifyTheAvailabilityOfDriverRatingColumnInPassengerProfileOfDispatchPortal_Test
		extends TestBase {
	...
	DEV_TC_2091_verifyTheAvailabilityOfDriverRatingColumnInPassengerProfileOfDispatchPortal_Main objVerifySighninMain;
	DEV_TC_2091_verifyTheAvailabilityOfDriverRatingColumnInPassengerProfileOfDispatchPortal_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_2091_verifyTheAvailabilityOfDriverRatingColumnInPassengerProfileOfDispatchPortal_Main(
					driver);
			objVerifySighninTest = new DEV_TC_2091_verifyTheAvailabilityOfDriverRatingColumnInPassengerProfileOfDispatchPortal_Test();
			objTestBase = new TestBase();
			...
			if (testStatus == "PASSED") {
				...
				objTestBase.defaultWaitTime(1000);
				objVerifySighninMain.clickOnPassanger();
				objTestBase.defaultWaitTime(3000);

				testStep = "Verification of Manage passanger page ";
				visibilityStatus = objVerifySighninMain.visibilityOfManagePassangerPage(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					if (localExecutionFlag == true)
						objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
					else
				...
				objTestBase.defaultWaitTime(3000);
				objVerifySighninMain.clickOnProfileIcon();
				objTestBase.defaultWaitTime(3000);

				testStep = "Verification of Profile page ";
				...
				objTestBase.defaultWaitTime(2000);
				objVerifySighninMain.clickOnPastTrips();
				objTestBase.defaultWaitTime(3000);

				testStep = "Verification of Newly added Driver Rating Column ";
				visibilityStatus = objVerifySighninMain.visibilityOfDriverRatingColumn(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					if (localExecutionFlag == true)
						objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
					else
