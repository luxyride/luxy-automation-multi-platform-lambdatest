...
public class DEV_TC_1888_VerifyTheAvailabilityOfPaymentMethodsInDispatchPortal_Test extends TestBase {
	...
	DEV_TC_1888_VerifyTheAvailabilityOfPaymentMethodsInDispatchPortal_Main objVerifySighninMain;
	DEV_TC_1888_VerifyTheAvailabilityOfPaymentMethodsInDispatchPortal_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1888_VerifyTheAvailabilityOfPaymentMethodsInDispatchPortal_Main(driver);
			objVerifySighninTest = new DEV_TC_1888_VerifyTheAvailabilityOfPaymentMethodsInDispatchPortal_Test();
			objTestBase = new TestBase();
