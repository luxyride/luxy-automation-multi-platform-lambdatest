...
public class DEV_TC_2344_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInDispatchPortal_Test
		extends TestBase {
	...
	DEV_TC_2344_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInDispatchPortal_Main objVerifyNewBookingDispatchMain;
	DEV_TC_2344_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInDispatchPortal_Test objVerifyNewBookingDispatchTest;
	...
	public void verificationOfNewBookingFromDispatchSite() throws Exception {
		try {
			...
			objVerifyNewBookingDispatchMain = new DEV_TC_2344_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInDispatchPortal_Main(
					driver);
			objVerifyNewBookingDispatchTest = new DEV_TC_2344_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInDispatchPortal_Test();
			objTestBase = new TestBase();
