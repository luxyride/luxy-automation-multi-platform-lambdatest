...
public class DEV_TC_2105_VerifyThatTheJFKLinkIsIncludedInTheConfirmationEmailForCustomersBookingToOrFromJFKAirport_Test
		extends TestBase {
	...
	DEV_TC_2105_VerifyThatTheJFKLinkIsIncludedInTheConfirmationEmailForCustomersBookingToOrFromJFKAirport_Main objVerifyNewBookingDispatchMain;
	DEV_TC_2105_VerifyThatTheJFKLinkIsIncludedInTheConfirmationEmailForCustomersBookingToOrFromJFKAirport_Test objVerifyNewBookingDispatchTest;
	...
	public void verificationOfNewBookingFromDispatchSite() throws Exception {
		try {
			...
			objVerifyNewBookingDispatchMain = new DEV_TC_2105_VerifyThatTheJFKLinkIsIncludedInTheConfirmationEmailForCustomersBookingToOrFromJFKAirport_Main(
					driver);
			objVerifyNewBookingDispatchTest = new DEV_TC_2105_VerifyThatTheJFKLinkIsIncludedInTheConfirmationEmailForCustomersBookingToOrFromJFKAirport_Test();
			objTestBase = new TestBase();
	...
	public String vechileBooking(String scenario, String testStatus) throws Exception {
		try {
			...
			testStep = "Verify Note regarding JFk Airport in Booking tipd id email ";
