...
public class DEV_TC_1681_VerifyTheRideInRedColorRowWhenTheRideIsBookedUnder10hrs_Test extends TestBase {
	...
	DEV_TC_1681_VerifyTheRideInRedColorRowWhenTheRideIsBookedUnder10hrs_Main objVerifyNewBookingDispatchMain;
	DEV_TC_1681_VerifyTheRideInRedColorRowWhenTheRideIsBookedUnder10hrs_Test objVerifyNewBookingDispatchTest;
	...
	public void verificationOfNewBookingFromDispatchSite() throws Exception {
		...
		try {
			...
			objVerifyNewBookingDispatchMain = new DEV_TC_1681_VerifyTheRideInRedColorRowWhenTheRideIsBookedUnder10hrs_Main(
					driver);
			objVerifyNewBookingDispatchTest = new DEV_TC_1681_VerifyTheRideInRedColorRowWhenTheRideIsBookedUnder10hrs_Test();
			objTestBase = new TestBase();
	...
	public String vechileBooking(String scenario, String testStatus) throws Exception {
		try {
			...
			objVerifyNewBookingDispatchMain.enterDate(true, false);
			objTestBase.defaultWaitTime(3000);
			...
			objTestBase.defaultWaitTime(2000);
			testStep = "visibility of red color back ground for under 10hrs ride";
			...
			if (testStatus == "PASSED") {
				...
				testStep = "Visibilitiy of Search input field";
	...
	public void afterClass() {
		...
		for (Map.Entry<String, String> entry : rideBookingDispatchIds.entrySet()) {
			System.out.println(
					"Booking IDs from TC: DEV_TC_1681_VerifyTheRideInRedColorRowWhenTheRideIsBookedUnder10hrs = "
							+ "Total TripIDs = " + rideBookingDispatchIds.size() + " - " + entry.getKey() + " - "
							+ entry.getValue());
			utillLogger
					.info("Booking IDs from TC: DEV_TC_1681_VerifyTheRideInRedColorRowWhenTheRideIsBookedUnder10hrs = "
							+ "Total TripIDs = " + rideBookingDispatchIds.size() + " - " + entry.getKey() + " - "
							+ entry.getValue());
		}
		utillLogger.info("//--------------------------------------------------------------------------------------//");
