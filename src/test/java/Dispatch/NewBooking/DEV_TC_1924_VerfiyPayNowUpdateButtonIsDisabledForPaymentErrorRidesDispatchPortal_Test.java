...
public class DEV_TC_1924_VerfiyPayNowUpdateButtonIsDisabledForPaymentErrorRidesDispatchPortal_Test extends TestBase {
	...
	DEV_TC_1924_VerfiyPayNowUpdateButtonIsDisabledForPaymentErrorRidesDispatchPortal_Main objVerifyNewBookingDispatchMain;
	DEV_TC_1924_VerfiyPayNowUpdateButtonIsDisabledForPaymentErrorRidesDispatchPortal_Test objVerifyNewBookingDispatchTest;
	...
	public void verificationOfNewBookingFromDispatchSite() throws Exception {
		...
		try {
			...
			objVerifyNewBookingDispatchMain = new DEV_TC_1924_VerfiyPayNowUpdateButtonIsDisabledForPaymentErrorRidesDispatchPortal_Main(
					driver);
			objVerifyNewBookingDispatchTest = new DEV_TC_1924_VerfiyPayNowUpdateButtonIsDisabledForPaymentErrorRidesDispatchPortal_Test();
			objTestBase = new TestBase();
	...
	public String vechileBooking(String scenario, String testStatus) throws Exception {
		try {
			...
			visibilityStatus = objVerifyNewBookingDispatchMain.visibilityOfUpdateRideButtonDisabled(visibilityStatus);
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)	objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);	else	lambdaTestStatusUpdate("passed", testStep);
				testStatus = "PASSED";
			} else {
			...
			objVerifyNewBookingDispatchMain.clickonArrivalMeetGreet();
			objTestBase.defaultWaitTime(2000);
			objVerifyNewBookingDispatchMain.enterArrivalMeetGreetDetails();
			objTestBase.defaultWaitTime(1000);
			...
			visibilityStatus = objVerifyNewBookingDispatchMain.visibilityOfPayNowButtonDisabled(visibilityStatus);
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)	objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);	else	lambdaTestStatusUpdate("passed", testStep);
				testStatus = "PASSED";
			} else {
