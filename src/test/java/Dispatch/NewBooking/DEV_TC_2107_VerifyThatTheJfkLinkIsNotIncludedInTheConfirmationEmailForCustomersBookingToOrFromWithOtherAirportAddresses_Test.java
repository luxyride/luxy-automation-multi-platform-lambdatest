...
public class DEV_TC_2107_VerifyThatTheJfkLinkIsNotIncludedInTheConfirmationEmailForCustomersBookingToOrFromWithOtherAirportAddresses_Test
		extends TestBase {
	...
	DEV_TC_2107_VerifyThatTheJfkLinkIsNotIncludedInTheConfirmationEmailForCustomersBookingToOrFromWithOtherAirportAddresses_Main objVerifyNewBookingDispatchMain;
	DEV_TC_2107_VerifyThatTheJfkLinkIsNotIncludedInTheConfirmationEmailForCustomersBookingToOrFromWithOtherAirportAddresses_Test objVerifyNewBookingDispatchTest;
	...
	public void verificationOfNewBookingFromDispatchSite() throws Exception {
		try {
			...
			objVerifyNewBookingDispatchMain = new DEV_TC_2107_VerifyThatTheJfkLinkIsNotIncludedInTheConfirmationEmailForCustomersBookingToOrFromWithOtherAirportAddresses_Main(
					driver);
			objVerifyNewBookingDispatchTest = new DEV_TC_2107_VerifyThatTheJfkLinkIsNotIncludedInTheConfirmationEmailForCustomersBookingToOrFromWithOtherAirportAddresses_Test();
			objTestBase = new TestBase();
	...
	public String vechileBooking(String scenario, String testStatus) throws Exception {
		try {
			...
			objVerifyNewBookingDispatchMain.clearButton();
			objTestBase.defaultWaitTime(1000);

			objVerifyNewBookingDispatchMain.emailIDSerach();
			objTestBase.defaultWaitTime(3000);

			
			testStep = "Verify Note should not displayed for other airports ";
			visibilityStatus = objVerifyNewBookingDispatchMain.verifyyopeMail(visibilityStatus);
			if (visibilityStatus.booleanValue() == true) {
