...
public class DEV_TC_1894_VerifyExtraStopIconUnderActionsInDispatchForTheRidesHavingExtraStops_Test extends TestBase {
	...
	DEV_TC_1894_VerifyExtraStopIconUnderActionsInDispatchForTheRidesHavingExtraStops_Main objVerifyNewBookingDispatchMain;
	DEV_TC_1894_VerifyExtraStopIconUnderActionsInDispatchForTheRidesHavingExtraStops_Test objVerifyNewBookingDispatchTest;
	...
	public void verificationOfNewBookingFromDispatchSite() throws Exception {
		...
		try {
			...
			objVerifyNewBookingDispatchMain = new DEV_TC_1894_VerifyExtraStopIconUnderActionsInDispatchForTheRidesHavingExtraStops_Main(
					driver);
			objVerifyNewBookingDispatchTest = new DEV_TC_1894_VerifyExtraStopIconUnderActionsInDispatchForTheRidesHavingExtraStops_Test();
			objTestBase = new TestBase();
	...
	public String vechileBooking(String scenario, String testStatus) throws Exception {
		try {
			...
			visibilityStatus = objVerifyNewBookingDispatchMain.verifyExtraStopButton(visibilityStatus);
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)
					objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
				else
