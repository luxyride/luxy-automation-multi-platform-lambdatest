...
public class DEV_TC_1891_VerifyNewBookingFunctionalityWithCreditOrDebitCardsUnderAvailaiblePaymentMethodsForDispatchPortal_Test
		extends TestBase {
	...
	DEV_TC_1891_VerifyNewBookingFunctionalityWithCreditOrDebitCardsUnderAvailaiblePaymentMethodsForDispatchPortal_Main objVerifyNewBookingDispatchMain;
	DEV_TC_1891_VerifyNewBookingFunctionalityWithCreditOrDebitCardsUnderAvailaiblePaymentMethodsForDispatchPortal_Test objVerifyNewBookingDispatchTest;
	...
	public void verificationOfNewBookingFromDispatchSite() throws Exception {
		...
		try {
			...
			objVerifyNewBookingDispatchMain = new DEV_TC_1891_VerifyNewBookingFunctionalityWithCreditOrDebitCardsUnderAvailaiblePaymentMethodsForDispatchPortal_Main(
					driver);
			objVerifyNewBookingDispatchTest = new DEV_TC_1891_VerifyNewBookingFunctionalityWithCreditOrDebitCardsUnderAvailaiblePaymentMethodsForDispatchPortal_Test();
			objTestBase = new TestBase();
