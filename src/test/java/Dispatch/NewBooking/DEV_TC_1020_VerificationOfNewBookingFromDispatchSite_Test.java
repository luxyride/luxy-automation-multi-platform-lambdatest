...
public class DEV_TC_1020_VerificationOfNewBookingFromDispatchSite_Test extends TestBase {
	...
	DEV_TC_1020_VerificationOfNewBookingFromDispatchSite_Main objVerifyNewBookingDispatchMain;
	DEV_TC_1020_VerificationOfNewBookingFromDispatchSite_Test objVerifyNewBookingDispatchTest;
	...
	public void verificationOfNewBookingFromDispatchSite() throws Exception {
		try {
			...
			objVerifyNewBookingDispatchMain = new DEV_TC_1020_VerificationOfNewBookingFromDispatchSite_Main(driver);
			objVerifyNewBookingDispatchTest = new DEV_TC_1020_VerificationOfNewBookingFromDispatchSite_Test();
			objTestBase = new TestBase();
