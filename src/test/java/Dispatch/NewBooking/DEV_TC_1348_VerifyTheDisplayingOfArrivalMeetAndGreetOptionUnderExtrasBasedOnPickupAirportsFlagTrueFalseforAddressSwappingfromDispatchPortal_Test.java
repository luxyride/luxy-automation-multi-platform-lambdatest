...
public class DEV_TC_1348_VerifyTheDisplayingOfArrivalMeetAndGreetOptionUnderExtrasBasedOnPickupAirportsFlagTrueFalseforAddressSwappingfromDispatchPortal_Test
		extends TestBase {
	...
	DEV_TC_1348_VerifyTheDisplayingOfArrivalMeetAndGreetOptionUnderExtrasBasedOnPickupAirportsFlagTrueFalseforAddressSwappingfromDispatchPortal_Main objVerifyArrivalMeetGreet_Main;
	DEV_TC_1348_VerifyTheDisplayingOfArrivalMeetAndGreetOptionUnderExtrasBasedOnPickupAirportsFlagTrueFalseforAddressSwappingfromDispatchPortal_Test objVerifyArrivalMeetGreet_Test;
	...
	public void ActivationOfNewUserAfterRegistration() throws Exception {
		...
		try {
			...
			objVerifyArrivalMeetGreet_Main = new DEV_TC_1348_VerifyTheDisplayingOfArrivalMeetAndGreetOptionUnderExtrasBasedOnPickupAirportsFlagTrueFalseforAddressSwappingfromDispatchPortal_Main(
					driver);
			objVerifyArrivalMeetGreet_Test = new DEV_TC_1348_VerifyTheDisplayingOfArrivalMeetAndGreetOptionUnderExtrasBasedOnPickupAirportsFlagTrueFalseforAddressSwappingfromDispatchPortal_Test();
			objTestBase = new TestBase();
	...
	public String vechileBooking(String scenario) throws Exception {
		try {
			...
			if (visibilityStatus == true) {
				...
				testStep = "Verify Rides details Page Navigation for the scenario - " + scenario + " - Before Swapping";
