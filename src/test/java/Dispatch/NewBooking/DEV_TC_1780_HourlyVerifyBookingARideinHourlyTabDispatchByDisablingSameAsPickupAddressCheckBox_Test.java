...
public class DEV_TC_1780_HourlyVerifyBookingARideinHourlyTabDispatchByDisablingSameAsPickupAddressCheckBox_Test extends TestBase {
	...
	DEV_TC_1780_HourlyVerifyBookingARideinHourlyTabDispatchByDisablingSameAsPickupAddressCheckBox_Main objVerifySighninMain;
	DEV_TC_1780_HourlyVerifyBookingARideinHourlyTabDispatchByDisablingSameAsPickupAddressCheckBox_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		try {
			...
			objVerifySighninMain = new DEV_TC_1780_HourlyVerifyBookingARideinHourlyTabDispatchByDisablingSameAsPickupAddressCheckBox_Main(driver);
			objVerifySighninTest = new DEV_TC_1780_HourlyVerifyBookingARideinHourlyTabDispatchByDisablingSameAsPickupAddressCheckBox_Test();
			objTestBase = new TestBase();
