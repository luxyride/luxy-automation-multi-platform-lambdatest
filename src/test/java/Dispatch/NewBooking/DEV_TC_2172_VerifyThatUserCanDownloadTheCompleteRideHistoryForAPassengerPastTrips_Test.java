...
public class DEV_TC_2172_VerifyThatUserCanDownloadTheCompleteRideHistoryForAPassengerPastTrips_Test extends TestBase {
	...
	DEV_TC_2172_VerifyThatUserCanDownloadTheCompleteRideHistoryForAPassengerPastTrips_Main objVerifySighninMain;
	DEV_TC_2172_VerifyThatUserCanDownloadTheCompleteRideHistoryForAPassengerPastTrips_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_2172_VerifyThatUserCanDownloadTheCompleteRideHistoryForAPassengerPastTrips_Main(
					driver);
			objVerifySighninTest = new DEV_TC_2172_VerifyThatUserCanDownloadTheCompleteRideHistoryForAPassengerPastTrips_Test();
			objTestBase = new TestBase();
			...
			objTestBase.defaultWaitTime(2000);
			objVerifySighninMain.clickPassengers();
			objTestBase.defaultWaitTime(3000);
			...
			testStep = "visibility of Ride History Button For Past Trips";
			visibilityStatus = objVerifySighninMain.visibilityOfRideHistory(visibilityStatus);
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)
					objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
				else
