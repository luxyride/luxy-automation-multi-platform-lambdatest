...
public class DEV_TC_2094_VerifyAvailabilityOfSchedulesMenuInDispatch_Test extends TestBase {
	...
	DEV_TC_2094_VerifyAvailabilityOfSchedulesMenuInDispatch_Main objVerifySighninMain;
	DEV_TC_2094_VerifyAvailabilityOfSchedulesMenuInDispatch_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_2094_VerifyAvailabilityOfSchedulesMenuInDispatch_Main(driver);
			objVerifySighninTest = new DEV_TC_2094_VerifyAvailabilityOfSchedulesMenuInDispatch_Test();
			objTestBase = new TestBase();
