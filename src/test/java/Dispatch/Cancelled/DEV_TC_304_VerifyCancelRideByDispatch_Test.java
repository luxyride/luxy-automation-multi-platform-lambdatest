...
public class DEV_TC_304_VerifyCancelRideByDispatch_Test extends TestBase {
	...
	DEV_TC_304_VerifyCancelRideByDispatch_Main objVerifyCancelRides_Main;
	DEV_TC_304_VerifyCancelRideByDispatch_Test objVerifyCancelRides_Test;
	UpdateExtentReportResults objupdateResults;
	TestBase objTestBase;

	@BeforeClass(groups = "Dispatch.Cancelled")
	@Parameters({"browser"})
	...
	@Test(groups = "Dispatch.Cancelled")
	public void verificationOfRideCancelDispatchSite() throws Exception {

		try {
			action = new Actions(driver);
			objVerifyCancelRides_Main = new DEV_TC_304_VerifyCancelRideByDispatch_Main(driver);
			objVerifyCancelRides_Test = new DEV_TC_304_VerifyCancelRideByDispatch_Test();
			objTestBase = new TestBase();
	...
	@AfterClass(groups = "Dispatch.Cancelled")
	public void afterClass() {
		driver.quit();
		utillLogger.info("//--------------------------------------------------------------------------------------//");
		for (Map.Entry<String, String> entry : rideBookingDispatchIds.entrySet()) {
			System.out
					.println("Cancelled Ride IDs from TC: DEV_TC_304_VerifyCancelRideByDispatch = " + "Total TripIDs = "
							+ rideBookingDispatchIds.size() + " - " + entry.getKey() + " - " + entry.getValue());

			utillLogger.info("Cancelled Ride IDs from TC: DEV_TC_304_VerifyCancelRideByDispatch = " + "Total TripIDs = "
					+ rideBookingDispatchIds.size() + " - " + entry.getKey() + " - " + entry.getValue());
		}
		utillLogger.info("//--------------------------------------------------------------------------------------//");
		utillLogger.info("## " + objVerifyCancelRides_Test.getClass().getSimpleName()
