...
public class DEV_TC_1050_VerifyPINConfirmationInProgressAvailableUpcomingCompletedCancelledRidesDispatch_Test
		extends TestBase {
	...
	DEV_TC_1050_VerifyPINConfirmationInProgressAvailableUpcomingCompletedCancelledRidesDispatch_Main objVerifyResendEmailMain;
	DEV_TC_1050_VerifyPINConfirmationInProgressAvailableUpcomingCompletedCancelledRidesDispatch_Test objVerifyResendEmailTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		try {
			...
			objVerifyResendEmailMain = new DEV_TC_1050_VerifyPINConfirmationInProgressAvailableUpcomingCompletedCancelledRidesDispatch_Main(
					driver);
			objVerifyResendEmailTest = new DEV_TC_1050_VerifyPINConfirmationInProgressAvailableUpcomingCompletedCancelledRidesDispatch_Test();
			objTestBase = new TestBase();
			...
			if (testStatus == "PASSED") {
				...
				for (Map.Entry<String, String> entry : rideBookingDispatchIds.entrySet()) {
					...
					testStep = "Verification of Update Ride Status - " + entry.getKey().toUpperCase() + " - Trip ID: "
							+ tripID;
					...
					testStep = "Verification of Navigating to the respective Ride Status Page "
	...
	private String verifyEmailConfirmation(String vehicleType, String tripID) {
		try {
			for (int i = 0; i <= 1; i++) {
				...
				utillLogger
						.info(objVerifyResendEmailMain.getClass().getSimpleName() + " - DEV_TC_1050_Email = " + eMail);
	...
	public void afterClass() {
		...
		for (Map.Entry<String, String> entry : rideBookingDispatchIds.entrySet()) {
			System.out.println(
					"Booking IDs from TC: DEV_TC_1050_VerifyPINConfirmationInProgressAvailableUpcomingCompletedCancelledRidesDispatch_Test = "
