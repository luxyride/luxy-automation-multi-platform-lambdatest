...
public class DEV_TC_620_VerifytheCreationOfPromoCodeForOneTimeUseOnlyWithPromoType_Percent_Test extends TestBase {
	...
	DEV_TC_620_VerifytheCreationOfPromoCodeForOneTimeUseOnlyWithPromoType_Percent_Main objVerifyPromocodePercentMain;
	DEV_TC_620_VerifytheCreationOfPromoCodeForOneTimeUseOnlyWithPromoType_Percent_Test objVerifyPromocodePercentTest;
	...
	public void verifytheCreationOfPromoCodeForMultipleUsesWithPromoType_PercentTest() throws Exception {
		try {
			...
			objVerifyPromocodePercentMain = new DEV_TC_620_VerifytheCreationOfPromoCodeForOneTimeUseOnlyWithPromoType_Percent_Main(
					driver);
			objVerifyPromocodePercentTest = new DEV_TC_620_VerifytheCreationOfPromoCodeForOneTimeUseOnlyWithPromoType_Percent_Test();
			objTestBase = new TestBase();
