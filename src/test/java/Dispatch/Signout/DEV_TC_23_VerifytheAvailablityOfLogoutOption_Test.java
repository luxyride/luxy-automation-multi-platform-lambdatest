...
public class DEV_TC_23_VerifytheAvailablityOfLogoutOption_Test extends TestBase {
	...
	DEV_TC_23_VerifytheAvailablityOfLogoutOption_Main objVerifylogoutMain;
	DEV_TC_23_VerifytheAvailablityOfLogoutOption_Test objVerifylogoutTest;

	@BeforeClass(groups = "Dispatch.Signout")
	@Parameters({"browser"})
	...
	@Test(groups = "Dispatch.Signout")
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		try {
			action = new Actions(driver);
			objVerifylogoutMain = new DEV_TC_23_VerifytheAvailablityOfLogoutOption_Main(driver);
			objVerifylogoutTest = new DEV_TC_23_VerifytheAvailablityOfLogoutOption_Test();
			objTestBase = new TestBase();
	...
	@AfterClass(groups = "Dispatch.Signout")
