...
public class DEV_TC_24_VerifytheLogoutFunctionality_Test extends TestBase {
	...
	DEV_TC_24_VerifytheLogoutFunctionality_Main objVerifylogoutMain;
	DEV_TC_24_VerifytheLogoutFunctionality_Test objVerifylogoutTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifylogoutMain = new DEV_TC_24_VerifytheLogoutFunctionality_Main(driver);
			objVerifylogoutTest = new DEV_TC_24_VerifytheLogoutFunctionality_Test();
			objTestBase = new TestBase();
