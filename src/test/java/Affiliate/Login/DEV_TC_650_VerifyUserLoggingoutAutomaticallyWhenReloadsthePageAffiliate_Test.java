...
public class DEV_TC_650_VerifyUserLoggingoutAutomaticallyWhenReloadsthePageAffiliate_Test extends TestBase {
	...
	DEV_TC_650_VerifyUserLoggingoutAutomaticallyWhenReloadsthePageAffiliate_Main objVerifySighninMain;
	DEV_TC_650_VerifyUserLoggingoutAutomaticallyWhenReloadsthePageAffiliate_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_650_VerifyUserLoggingoutAutomaticallyWhenReloadsthePageAffiliate_Main(
					driver);
			objVerifySighninTest = new DEV_TC_650_VerifyUserLoggingoutAutomaticallyWhenReloadsthePageAffiliate_Test();
			objTestBase = new TestBase();
			...
			if (testStatus == "PASSED") {
				...
				testStep = "Verification of Affiliate Portal Loggedin - After Refresh the page";
