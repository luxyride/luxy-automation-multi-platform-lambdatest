...
public class DEV_TC_52_VerifySignInWithValidCredentials_Test extends TestBase {
	...
	DEV_TC_52_VerifySignInWithValidCredentials_Main objVerifySighninMain;
	DEV_TC_52_VerifySignInWithValidCredentials_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_52_VerifySignInWithValidCredentials_Main(driver);
			objVerifySighninTest = new DEV_TC_52_VerifySignInWithValidCredentials_Test();
			objTestBase = new TestBase();
