...
public class DEV_TC_1493_VerifyTheAvailabilityOfAPSACheckBoxAndDocumentDownloadLinkForTheExistingAffiliateInAffiliateDetailsPageInAffiliatePortal_Test
		extends TestBase {
	...
	DEV_TC_1493_VerifyTheAvailabilityOfAPSACheckBoxAndDocumentDownloadLinkForTheExistingAffiliateInAffiliateDetailsPageInAffiliatePortal_Main objVerifylogoutMain;
	DEV_TC_1493_VerifyTheAvailabilityOfAPSACheckBoxAndDocumentDownloadLinkForTheExistingAffiliateInAffiliateDetailsPageInAffiliatePortal_Test objVerifylogoutTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifylogoutMain = new DEV_TC_1493_VerifyTheAvailabilityOfAPSACheckBoxAndDocumentDownloadLinkForTheExistingAffiliateInAffiliateDetailsPageInAffiliatePortal_Main(
					driver);
			objVerifylogoutTest = new DEV_TC_1493_VerifyTheAvailabilityOfAPSACheckBoxAndDocumentDownloadLinkForTheExistingAffiliateInAffiliateDetailsPageInAffiliatePortal_Test();
			objTestBase = new TestBase();
			...
			testStep = "Verification of Clicking on UPDATE button without agreeing to the APSA agreement. ";
			objVerifylogoutMain.clickOnUpdateBtn();
			objTestBase.defaultWaitTime(3000);
			visibilityStatus = objVerifylogoutMain.visibilityOfAlertMessage(visibilityStatus);
			objTestBase.defaultWaitTime(2000);
			if (visibilityStatus.booleanValue() == true) {
				screenshotPath = getScreenshot(driver, "Verifylogin");
				if (localExecutionFlag == true)
			...
			if (!environmentCode.equalsIgnoreCase("prod")) {
				testStep = "Verification of Clicking on UPDATE button After agreeing to the APSA agreement. ";
