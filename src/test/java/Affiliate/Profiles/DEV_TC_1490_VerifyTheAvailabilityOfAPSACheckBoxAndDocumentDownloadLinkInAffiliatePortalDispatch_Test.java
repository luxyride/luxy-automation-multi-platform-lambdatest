...
public class DEV_TC_1490_VerifyTheAvailabilityOfAPSACheckBoxAndDocumentDownloadLinkInAffiliatePortalDispatch_Test
		extends TestBase {
	...
	DEV_TC_1490_VerifyTheAvailabilityOfAPSACheckBoxAndDocumentDownloadLinkInAffiliatePortalDispatch_Main objVerifylogoutMain;
	DEV_TC_1490_VerifyTheAvailabilityOfAPSACheckBoxAndDocumentDownloadLinkInAffiliatePortalDispatch_Test objVerifylogoutTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifylogoutMain = new DEV_TC_1490_VerifyTheAvailabilityOfAPSACheckBoxAndDocumentDownloadLinkInAffiliatePortalDispatch_Main(
					driver);
			objVerifylogoutTest = new DEV_TC_1490_VerifyTheAvailabilityOfAPSACheckBoxAndDocumentDownloadLinkInAffiliatePortalDispatch_Test();
			objTestBase = new TestBase();
