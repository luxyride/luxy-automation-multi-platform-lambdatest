...
public class DEV_TC_1950_VerifyTheAvailabilityLevelOfInsuranceOptionsForPartnersInAffiliatePortal_Test
		extends TestBase {
	...
	DEV_TC_1950_VerifyTheAvailabilityLevelOfInsuranceOptionsForPartnersInAffiliatePortal_Main objVerifylogoutMain;
	DEV_TC_1950_VerifyTheAvailabilityLevelOfInsuranceOptionsForPartnersInAffiliatePortal_Test objVerifylogoutTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifylogoutMain = new DEV_TC_1950_VerifyTheAvailabilityLevelOfInsuranceOptionsForPartnersInAffiliatePortal_Main(
					driver);
			objVerifylogoutTest = new DEV_TC_1950_VerifyTheAvailabilityLevelOfInsuranceOptionsForPartnersInAffiliatePortal_Test();
			objTestBase = new TestBase();
