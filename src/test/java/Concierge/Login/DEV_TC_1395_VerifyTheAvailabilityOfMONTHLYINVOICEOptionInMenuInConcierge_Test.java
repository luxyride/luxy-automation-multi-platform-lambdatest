...
public class DEV_TC_1395_VerifyTheAvailabilityOfMONTHLYINVOICEOptionInMenuInConcierge_Test extends TestBase {
	...
	DEV_TC_1395_VerifyTheAvailabilityOfMONTHLYINVOICEOptionInMenuInConcierge_Main objVerifyLogout_Main;
	DEV_TC_1395_VerifyTheAvailabilityOfMONTHLYINVOICEOptionInMenuInConcierge_Test objVerifyLogout_Test;
	...
	public void VerifyUserShouldNotLogoutAutomaticallyWhenReloadsTheConciergePage() throws Exception {
		...
		try {
			...
			objVerifyLogout_Main = new DEV_TC_1395_VerifyTheAvailabilityOfMONTHLYINVOICEOptionInMenuInConcierge_Main(
					driver);
			objVerifyLogout_Test = new DEV_TC_1395_VerifyTheAvailabilityOfMONTHLYINVOICEOptionInMenuInConcierge_Test();
			objTestBase = new TestBase();
			...
			if (testStatus == "PASSED") {
				...
				testStep = "Verify Page Contents from Monthly Invoice Page.?";
				visibilityStatus = objVerifyLogout_Main.verifyPageContents(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					if (localExecutionFlag == true)
						objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
					else
