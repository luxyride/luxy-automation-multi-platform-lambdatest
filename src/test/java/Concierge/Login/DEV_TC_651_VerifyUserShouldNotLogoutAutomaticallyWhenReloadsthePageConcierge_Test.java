...
public class DEV_TC_651_VerifyUserShouldNotLogoutAutomaticallyWhenReloadsthePageConcierge_Test extends TestBase {
	...
	DEV_TC_651_VerifyUserShouldNotLogoutAutomaticallyWhenReloadsthePageConcierge_Main objVerifyLogout_Main;
	DEV_TC_651_VerifyUserShouldNotLogoutAutomaticallyWhenReloadsthePageConcierge_Test objVerifyLogout_Test;
	...
	public void VerifyUserShouldNotLogoutAutomaticallyWhenReloadsTheDispatchPage() throws Exception {
		...
		try {
			...
			objVerifyLogout_Main = new DEV_TC_651_VerifyUserShouldNotLogoutAutomaticallyWhenReloadsthePageConcierge_Main(
					driver);
			objVerifyLogout_Test = new DEV_TC_651_VerifyUserShouldNotLogoutAutomaticallyWhenReloadsthePageConcierge_Test();
			objTestBase = new TestBase();
			...
			if (testStatus == "PASSED") {
				...
				testStep = "Verification of Concierge Portal Login - After Refresh the page";
