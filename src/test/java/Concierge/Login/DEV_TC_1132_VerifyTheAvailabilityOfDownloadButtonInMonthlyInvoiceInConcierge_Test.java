...
public class DEV_TC_1132_VerifyTheAvailabilityOfDownloadButtonInMonthlyInvoiceInConcierge_Test extends TestBase {
	...
	DEV_TC_1132_VerifyTheAvailabilityOfDownloadButtonInMonthlyInvoiceInConcierge_Main objVerifyLogout_Main;
	DEV_TC_1132_VerifyTheAvailabilityOfDownloadButtonInMonthlyInvoiceInConcierge_Test objVerifyLogout_Test;
	...
	public void VerifyUserShouldNotLogoutAutomaticallyWhenReloadsTheConciergePage() throws Exception {
		...
		try {
			...
			objVerifyLogout_Main = new DEV_TC_1132_VerifyTheAvailabilityOfDownloadButtonInMonthlyInvoiceInConcierge_Main(
					driver);
			objVerifyLogout_Test = new DEV_TC_1132_VerifyTheAvailabilityOfDownloadButtonInMonthlyInvoiceInConcierge_Test();
			objTestBase = new TestBase();
			...
			if (testStatus == "PASSED") {
				...
				testStep = "Verify DOWNLOAD Option is displayed from Monthly Invoice Page.?";
				visibilityStatus = objVerifyLogout_Main.verifyDownloadOptionDisplayed(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					if (localExecutionFlag == true)
						objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
					else
