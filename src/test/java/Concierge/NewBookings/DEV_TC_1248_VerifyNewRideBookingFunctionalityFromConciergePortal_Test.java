...
public class DEV_TC_1248_VerifyNewRideBookingFunctionalityFromConciergePortal_Test extends TestBase {
	...
	DEV_TC_1248_VerifyNewRideBookingFunctionalityFromConciergePortal_Main objVerifyNewBookingConciergeMain;
	DEV_TC_1248_VerifyNewRideBookingFunctionalityFromConciergePortal_Test objVerifyNewBookingConciergeTest;
	...
	public void verificationOfNewBookingFromDispatchSite() throws Exception {
		...
		try {
			...
			objVerifyNewBookingConciergeMain = new DEV_TC_1248_VerifyNewRideBookingFunctionalityFromConciergePortal_Main(
					driver);
			objVerifyNewBookingConciergeTest = new DEV_TC_1248_VerifyNewRideBookingFunctionalityFromConciergePortal_Test();
			objTestBase = new TestBase();
