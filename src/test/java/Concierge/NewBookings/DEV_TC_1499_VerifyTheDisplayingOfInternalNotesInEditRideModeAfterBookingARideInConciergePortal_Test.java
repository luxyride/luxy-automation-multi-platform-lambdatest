...
public class DEV_TC_1499_VerifyTheDisplayingOfInternalNotesInEditRideModeAfterBookingARideInConciergePortal_Test
		extends TestBase {
	...
	DEV_TC_1499_VerifyTheDisplayingOfInternalNotesInEditRideModeAfterBookingARideInConciergePortal_Main objVerifySighninMain;
	DEV_TC_1499_VerifyTheDisplayingOfInternalNotesInEditRideModeAfterBookingARideInConciergePortal_Test objVerifySighninTest;
	...
	public void VerifyLogInPageOfTravelAgentWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1499_VerifyTheDisplayingOfInternalNotesInEditRideModeAfterBookingARideInConciergePortal_Main(
					driver);
			objVerifySighninTest = new DEV_TC_1499_VerifyTheDisplayingOfInternalNotesInEditRideModeAfterBookingARideInConciergePortal_Test();
			objTestBase = new TestBase();
