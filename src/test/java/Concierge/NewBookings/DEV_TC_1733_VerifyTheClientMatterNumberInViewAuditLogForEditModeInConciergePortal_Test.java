...
public class DEV_TC_1733_VerifyTheClientMatterNumberInViewAuditLogForEditModeInConciergePortal_Test extends TestBase {
	...
	DEV_TC_1733_VerifyTheClientMatterNumberInViewAuditLogForEditModeInConciergePortal_Main objVerifyNewBookingConciergeMain;
	DEV_TC_1733_VerifyTheClientMatterNumberInViewAuditLogForEditModeInConciergePortal_Test objVerifyNewBookingConciergeTest;
	...
	public void verificationOfNewBookingFromDispatchSite() throws Exception {
		...
		try {
			...
			objVerifyNewBookingConciergeMain = new DEV_TC_1733_VerifyTheClientMatterNumberInViewAuditLogForEditModeInConciergePortal_Main(
					driver);
			objVerifyNewBookingConciergeTest = new DEV_TC_1733_VerifyTheClientMatterNumberInViewAuditLogForEditModeInConciergePortal_Test();
			objTestBase = new TestBase();
			...
			if (visibilityStatus.booleanValue() == true) {
				...
				if (tripID != null) {
					driver.navigate().refresh();
					objTestBase.defaultWaitTime(3000);
					objVerifyNewBookingConciergeMain.enterSearchInput(tripID);
					objTestBase.defaultWaitTime(2000);
					...
					testStep = "Verification of Client Matter Number Updated value After Successfuly updated from EDIT ride details in View Audit Logs";
					visibilityStatus = objVerifyNewBookingConciergeMain
							.verifyClientMatterNumberAfterUpdatedSuccessfullyInViewAuditLogs(visibilityStatus, tripID,
