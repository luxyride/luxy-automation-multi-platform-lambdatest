...
public class DEV_TC_2066_VerifyTheAvailabilityOfAddAnotherTripButtonInEventAndSpecialServiceQuoteRequestPage_Test extends TestBase {
	...
	DEV_TC_2066_VerifyTheAvailabilityOfAddAnotherTripButtonInEventAndSpecialServiceQuoteRequestPage_Main objVerifySplEventsMain;
	DEV_TC_2066_VerifyTheAvailabilityOfAddAnotherTripButtonInEventAndSpecialServiceQuoteRequestPage_Test objVerifySplEventsTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		try {
			...
			objVerifySplEventsMain = new DEV_TC_2066_VerifyTheAvailabilityOfAddAnotherTripButtonInEventAndSpecialServiceQuoteRequestPage_Main(driver);
			objVerifySplEventsTest = new DEV_TC_2066_VerifyTheAvailabilityOfAddAnotherTripButtonInEventAndSpecialServiceQuoteRequestPage_Test();
			objTestBase = new TestBase();
