...
public class DEV_TC_2360_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInConciergePortal_Test
		extends TestBase {
	...
	DEV_TC_2360_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInConciergePortal_Main objVerifyNewBookingConciergeMain;
	DEV_TC_2360_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInConciergePortal_Test objVerifyNewBookingConciergeTest;
	...
	public void verificationOfNewBookingFromDispatchSite() throws Exception {
		...
		try {
			...
			objVerifyNewBookingConciergeMain = new DEV_TC_2360_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInConciergePortal_Main(
					driver);
			objVerifyNewBookingConciergeTest = new DEV_TC_2360_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInConciergePortal_Test();
			objTestBase = new TestBase();
	...
	public String vechileBooking(String scenario, String testStatus) throws Exception {
		try {
			...
			testStep = "Verify list of available vehicles";
			...
			objTestBase.defaultWaitTime(1000);
			objVerifyNewBookingConciergeMain.enterLastName();
			objTestBase.defaultWaitTime(2000);
