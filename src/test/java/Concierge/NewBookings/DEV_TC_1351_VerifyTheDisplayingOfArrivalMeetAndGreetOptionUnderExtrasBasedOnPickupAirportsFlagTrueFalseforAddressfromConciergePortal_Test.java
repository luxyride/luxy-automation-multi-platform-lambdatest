...
public class DEV_TC_1351_VerifyTheDisplayingOfArrivalMeetAndGreetOptionUnderExtrasBasedOnPickupAirportsFlagTrueFalseforAddressfromConciergePortal_Test
		extends TestBase {
	...
	DEV_TC_1351_VerifyTheDisplayingOfArrivalMeetAndGreetOptionUnderExtrasBasedOnPickupAirportsFlagTrueFalseforAddressfromConciergePortal_Main objVerifyArrivalMeetGreet_Main;
	DEV_TC_1351_VerifyTheDisplayingOfArrivalMeetAndGreetOptionUnderExtrasBasedOnPickupAirportsFlagTrueFalseforAddressfromConciergePortal_Test objVerifyArrivalMeetGreet_Test;
	...
	public void ActivationOfNewUserAfterRegistration() throws Exception {
		...
		try {
			...
			objVerifyArrivalMeetGreet_Main = new DEV_TC_1351_VerifyTheDisplayingOfArrivalMeetAndGreetOptionUnderExtrasBasedOnPickupAirportsFlagTrueFalseforAddressfromConciergePortal_Main(
					driver);
			objVerifyArrivalMeetGreet_Test = new DEV_TC_1351_VerifyTheDisplayingOfArrivalMeetAndGreetOptionUnderExtrasBasedOnPickupAirportsFlagTrueFalseforAddressfromConciergePortal_Test();
			objTestBase = new TestBase();
