...
public class DEV_TC_1900_VerifyNewBookingFunctionalityWithCreditOrDebitCardsUnderAvailaiblePaymentMethodsForConciergePortal_Test
		extends TestBase {
	...
	DEV_TC_1900_VerifyNewBookingFunctionalityWithCreditOrDebitCardsUnderAvailaiblePaymentMethodsForConciergePortal_Main objVerifyNewBookingConciergeMain;
	DEV_TC_1900_VerifyNewBookingFunctionalityWithCreditOrDebitCardsUnderAvailaiblePaymentMethodsForConciergePortal_Test objVerifyNewBookingConciergeTest;
	...
	public void verificationOfNewBookingFromDispatchSite() throws Exception {
		...
		try {
			...
			objVerifyNewBookingConciergeMain = new DEV_TC_1900_VerifyNewBookingFunctionalityWithCreditOrDebitCardsUnderAvailaiblePaymentMethodsForConciergePortal_Main(
					driver);
			objVerifyNewBookingConciergeTest = new DEV_TC_1900_VerifyNewBookingFunctionalityWithCreditOrDebitCardsUnderAvailaiblePaymentMethodsForConciergePortal_Test();
			objTestBase = new TestBase();
	...
	public String vechileBooking(String scenario, String testStatus) throws Exception {
		try {
			...
			visibilityStatus = objVerifyNewBookingConciergeMain.visibilityOfPaymentOptions(visibilityStatus);
			if (visibilityStatus.booleanValue() == true) {
