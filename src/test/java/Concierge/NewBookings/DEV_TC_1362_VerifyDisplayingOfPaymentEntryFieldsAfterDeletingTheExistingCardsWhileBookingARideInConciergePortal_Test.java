...
public class DEV_TC_1362_VerifyDisplayingOfPaymentEntryFieldsAfterDeletingTheExistingCardsWhileBookingARideInConciergePortal_Test
		extends TestBase {
	...
	DEV_TC_1362_VerifyDisplayingOfPaymentEntryFieldsAfterDeletingTheExistingCardsWhileBookingARideInConciergePortal_Main objVerifyNewBookingDispatchMain;
	DEV_TC_1362_VerifyDisplayingOfPaymentEntryFieldsAfterDeletingTheExistingCardsWhileBookingARideInConciergePortal_Test objVerifyNewBookingDispatchTest;
	...
	public void VerifyDisplayingOfPaymentEntryFieldsAfterDeletingTheExistingCardsWhileBookingARideInConciergePortal()
		...
		try {
			...
			objVerifyNewBookingDispatchMain = new DEV_TC_1362_VerifyDisplayingOfPaymentEntryFieldsAfterDeletingTheExistingCardsWhileBookingARideInConciergePortal_Main(
					driver);
			objVerifyNewBookingDispatchTest = new DEV_TC_1362_VerifyDisplayingOfPaymentEntryFieldsAfterDeletingTheExistingCardsWhileBookingARideInConciergePortal_Test();
			objTestBase = new TestBase();
