...
public class DEV_TC_1901_VerifyNewBookingFunctionalityWithGOOGLEPAYUnderAvailaiblePaymentMethodsForConciergePortal_Test
		extends TestBase {
	...
	DEV_TC_1901_VerifyNewBookingFunctionalityWithGOOGLEPAYUnderAvailaiblePaymentMethodsForConciergePortal_Main objVerifyNewBookingConciergeMain;
	DEV_TC_1901_VerifyNewBookingFunctionalityWithGOOGLEPAYUnderAvailaiblePaymentMethodsForConciergePortal_Test objVerifyNewBookingConciergeTest;
	...
	public void verificationOfNewBookingFromDispatchSite() throws Exception {
		...
		try {
			...
			objVerifyNewBookingConciergeMain = new DEV_TC_1901_VerifyNewBookingFunctionalityWithGOOGLEPAYUnderAvailaiblePaymentMethodsForConciergePortal_Main(
					driver);
			objVerifyNewBookingConciergeTest = new DEV_TC_1901_VerifyNewBookingFunctionalityWithGOOGLEPAYUnderAvailaiblePaymentMethodsForConciergePortal_Test();
			objTestBase = new TestBase();
			...
			visibilityStatus = objVerifyNewBookingConciergeMain.verifyGMailAccountLogin(visibilityStatus);
	...
	public String vechileBooking(String scenario, String testStatus) throws Exception {
		try {
			...
			objVerifyNewBookingConciergeMain.clickPointToPointTab();
			objTestBase.defaultWaitTime(3000);
			...
			visibilityStatus = objVerifyNewBookingConciergeMain.verifyGooglePayOptionVisibility(visibilityStatus);
			objTestBase.defaultWaitTime(2000);
			
			String parentWindow = driver.getWindowHandle();
			objTestBase.defaultWaitTime(1000);
			
			objVerifyNewBookingConciergeMain.clickOnpayingWithgooglePayOption();
			objTestBase.defaultWaitTime(10000);
			
			testStep = "Verification of Google Payment Continue popup";
			visibilityStatus = objVerifyNewBookingConciergeMain.verifyContinueBtnVisibility(parentWindow, visibilityStatus);
			objTestBase.defaultWaitTime(2000);
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)
					objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
	...
	public void afterClass() {
		...
		// DEV_TC_1901_VerifyNewBookingFunctionalityWithGOOGLEPAYUnderAvailaiblePaymentMethodsForConciergePortal_Test:
		utillLogger.info("//--------------------------------------------------------------------------------------//");
