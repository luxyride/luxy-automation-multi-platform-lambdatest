...
public class DEV_TC_1889_VerifyTheAvailabilityOfPaymentMethodsInConciergePortal_Test extends TestBase {
	...
	DEV_TC_1889_VerifyTheAvailabilityOfPaymentMethodsInConciergePortal_Main objVerifySighninMain;
	DEV_TC_1889_VerifyTheAvailabilityOfPaymentMethodsInConciergePortal_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1889_VerifyTheAvailabilityOfPaymentMethodsInConciergePortal_Main(driver);
			objVerifySighninTest = new DEV_TC_1889_VerifyTheAvailabilityOfPaymentMethodsInConciergePortal_Test();
			objTestBase = new TestBase();
