...
public class DEV_TC_1643_VerifyTheAvailabilityOfSpecialEventsTabInConciergePortal_Test extends TestBase {
	...
	DEV_TC_1643_VerifyTheAvailabilityOfSpecialEventsTabInConciergePortal_Main objVerifySplEventsMain;
	DEV_TC_1643_VerifyTheAvailabilityOfSpecialEventsTabInConciergePortal_Test objVerifySplEventsTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		try {
			...
			objVerifySplEventsMain = new DEV_TC_1643_VerifyTheAvailabilityOfSpecialEventsTabInConciergePortal_Main(driver);
			objVerifySplEventsTest = new DEV_TC_1643_VerifyTheAvailabilityOfSpecialEventsTabInConciergePortal_Test();
			objTestBase = new TestBase();
