...
public class DEV_TC_1523_VerifyFilteringOfTravelAgentRidesInConciergePortalUsingOriginatorTypeAfterRidesEditFromDispatch_Test
		extends TestBase {
	String tripID;
	String currURL;
	Actions action;
	...
	DEV_TC_1523_VerifyFilteringOfTravelAgentRidesInConciergePortalUsingOriginatorTypeAfterRidesEditFromDispatch_Main objVerifyEditDetails_Main;
	DEV_TC_1523_VerifyFilteringOfTravelAgentRidesInConciergePortalUsingOriginatorTypeAfterRidesEditFromDispatch_Test objVerifyEditDetails_Test;
	...
	public void verificationOfRideEditDetailsFromDispatchSite() throws Exception {
		try {
			...
			objVerifyEditDetails_Main = new DEV_TC_1523_VerifyFilteringOfTravelAgentRidesInConciergePortalUsingOriginatorTypeAfterRidesEditFromDispatch_Main(
					driver);
			objVerifyEditDetails_Test = new DEV_TC_1523_VerifyFilteringOfTravelAgentRidesInConciergePortalUsingOriginatorTypeAfterRidesEditFromDispatch_Test();
			objTestBase = new TestBase();
			...
			if (!travelAgentTripIDsOriginator.isEmpty()) {
				...
				for (Map.Entry<String, String> entry : travelAgentTripIDsOriginator.entrySet()) {
					...
					if (tripID != "No_Data") {
						if ((!scenario.equalsIgnoreCase("concierge_Cancelled"))
							...
							if (entry.getKey().contains("travelAgent_Rides_All"))
								objVerifyEditDetails_Main.clickonAllTab();
							else if (entry.getKey().contains("travelAgent_InProgress"))
								objVerifyEditDetails_Main.clickonInProgressTab();
							else if (entry.getKey().contains("travelAgent_Upcoming"))
								objVerifyEditDetails_Main.clickonUpcomingTab();
							else if (entry.getKey().contains("travelAgent_Available"))
				...
				if (!travelAgentTripIDsOriginator.isEmpty()) {
					...
					for (Map.Entry<String, String> entry : travelAgentTripIDsOriginator.entrySet()) {
						...
						if (tripID != "No_Data") {
							if (scenario != "travelAgent_Cancelled" && scenario != "travelAgent_Completed")
							...
							if (scenario.contains("travelAgent_Rides_All"))
								objVerifyEditDetails_Main.clickonAllTab();
							else if (scenario.contains("travelAgent_InProgress"))
								objVerifyEditDetails_Main.clickonInProgressTab();
							else if (scenario.contains("travelAgent_Upcoming"))
								objVerifyEditDetails_Main.clickonUpcomingTab();
							else if (scenario.contains("travelAgent_Available"))
								objVerifyEditDetails_Main.clickonAvailableTab();
