...
public class DEV_TC_1062_VerifyPINConfirmationEmailNotSentToCustomerWhenRidesEditedWhileBookedConcierge_Test
		extends TestBase {
	...
	DEV_TC_1062_VerifyPINConfirmationEmailNotSentToCustomerWhenRidesEditedWhileBookedConcierge_Main objVerifyResendEmailMain;
	DEV_TC_1062_VerifyPINConfirmationEmailNotSentToCustomerWhenRidesEditedWhileBookedConcierge_Test objVerifyResendEmailTest;
	...
	public void verifyPINConfirmationEmailNotSentToCustomerWhenRidesEditedWhileBookedConcierge() throws Exception {
		try {
			int indexCount = 1;
			action = new Actions(driver);
			objVerifyResendEmailMain = new DEV_TC_1062_VerifyPINConfirmationEmailNotSentToCustomerWhenRidesEditedWhileBookedConcierge_Main(
					driver);
			objVerifyResendEmailTest = new DEV_TC_1062_VerifyPINConfirmationEmailNotSentToCustomerWhenRidesEditedWhileBookedConcierge_Test();
			objTestBase = new TestBase();
			...
			if (!rideBookingIdsConcierge.isEmpty()) {
				...
				testStep = "EDIT Rides Skipped due to EMPTY Rides Captured from DEV_TC_1248_VerifyNewRideBookingFunctionalityFromConciergePortal_Test";
				objupdateResults.updateResults(screenshotPath, logger, LogStatus.SKIP, testStep, exception);
				testStatus = "FAILED";
			}
			objTestBase.defaultWaitTime(1000);
		...
		try {
			if (testStatus == "PASSED") {
				for (int i = 0; i <= 1; i++) {
					...
					utillLogger.info(
							objVerifyResendEmailMain.getClass().getSimpleName() + " - DEV_TC_1051_Email = " + eMail);
	...
	public void afterClass() {
		...
		// DEV_TC_1062_VerifyPINConfirmationEmailNotSentToCustomerWhenRidesEditedWhileBookedConcierge_Test:
		utillLogger.info("//--------------------------------------------------------------------------------------//");
		for (Map.Entry<String, String> entry : rideBookingIdsConcierge.entrySet()) {
			System.out.println(
					"Booking IDs from TC: DEV_TC_1062_VerifyPINConfirmationEmailNotSentToCustomerWhenRidesEditedWhileBookedConcierge_Test = "
