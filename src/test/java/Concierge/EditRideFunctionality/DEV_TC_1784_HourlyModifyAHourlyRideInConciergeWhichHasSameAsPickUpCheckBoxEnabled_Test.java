...
public class DEV_TC_1784_HourlyModifyAHourlyRideInConciergeWhichHasSameAsPickUpCheckBoxEnabled_Test extends TestBase {
	String tripID;
	String currURL;
	...
	DEV_TC_1784_HourlyModifyAHourlyRideInConciergeWhichHasSameAsPickUpCheckBoxEnabled_Main objVerifyEditDetails_Main;
	DEV_TC_1784_HourlyModifyAHourlyRideInConciergeWhichHasSameAsPickUpCheckBoxEnabled_Test objVerifyEditDetails_Test;
	...
	public void verificationOfRideEditDetailsFromDispatchSite() throws Exception {
		try {
			...
			objVerifyEditDetails_Main = new DEV_TC_1784_HourlyModifyAHourlyRideInConciergeWhichHasSameAsPickUpCheckBoxEnabled_Main(
					driver);
			objVerifyEditDetails_Test = new DEV_TC_1784_HourlyModifyAHourlyRideInConciergeWhichHasSameAsPickUpCheckBoxEnabled_Test();
			objTestBase = new TestBase();
			...
			if (!conciergehourlyRideTripID.isEmpty()) {
				objVerifyEditDetails_Main.clickNewBooking();
				objTestBase.defaultWaitTime(2000);
				objVerifyEditDetails_Main.clickRidesSection();
				objTestBase.defaultWaitTime(3000);

				testStep = "Verification of Rides All Page loaded for " + conciergehourlyRideTripID + " - Trip ID: "
				...
				driver.navigate().refresh();
				objTestBase.defaultWaitTime(3000);
				tripID = conciergehourlyRideTripID;
				objVerifyEditDetails_Main.searchRideId(tripID);
				objTestBase.defaultWaitTime(5000);

				// Validate the TripID Details:
				testStep = "Verify the RideStatus, PassengerName & Ride Booked Date for " + conciergehourlyRideTripID
				...
				testStep = "Validate EDIT Ride for " + conciergehourlyRideTripID + " - Trip ID: " + tripID;
				if (visibilityStatus.booleanValue() == true) {
					objVerifyEditDetails_Main.editRideDetails();
					objTestBase.defaultWaitTime(3000);

					testStep = "Verification of Edit Ride Booking for " + conciergehourlyRideTripID + " - Trip ID: "
							+ tripID + " - Before Update";
					...
					if (visibilityStatus.booleanValue() == true) {
						...
						if (!environmentCode.equalsIgnoreCase("prod")) {
							...
							testStep = "Verification of " + conciergehourlyRideTripID
					...
					if (tripID != null) {
						...
						testStep = "Verificatin of Edit Ride Booking for " + conciergehourlyRideTripID + " - Trip ID: "
								+ tripID + " - After Update";
						visibilityStatus = objVerifyEditDetails_Main.verifyEDITRideDetailsPage(visibilityStatus);
						if (visibilityStatus.booleanValue() == true) {
							objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
