...
public class DEV_TC_1268_VerifyEditTravelArrangerFunctionalityInManageTravelArrangerPage_Test extends TestBase {
	...
	DEV_TC_1268_VerifyEditTravelArrangerFunctionalityInManageTravelArrangerPage_Main objVerifySighninMain;
	DEV_TC_1268_VerifyEditTravelArrangerFunctionalityInManageTravelArrangerPage_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1268_VerifyEditTravelArrangerFunctionalityInManageTravelArrangerPage_Main(
					driver);
			objVerifySighninTest = new DEV_TC_1268_VerifyEditTravelArrangerFunctionalityInManageTravelArrangerPage_Test();
			objTestBase = new TestBase();
