...
public class DEV_TC_1738_VerifyTheAvailabilityOfOptInVerificationSecurityCheckboxInDispatchTravelArranger_Test
		extends TestBase {
	...
	DEV_TC_1738_VerifyTheAvailabilityOfOptInVerificationSecurityCheckboxInDispatchTravelArranger_Main objVerifySighninMain;
	DEV_TC_1738_VerifyTheAvailabilityOfOptInVerificationSecurityCheckboxInDispatchTravelArranger_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1738_VerifyTheAvailabilityOfOptInVerificationSecurityCheckboxInDispatchTravelArranger_Main(
					driver);
			objVerifySighninTest = new DEV_TC_1738_VerifyTheAvailabilityOfOptInVerificationSecurityCheckboxInDispatchTravelArranger_Test();
			objTestBase = new TestBase();
			...
			if (testStatus == "PASSED") {
				...
				testStep = "Visibility of opt in check box in edit page";
				visibilityStatus = objVerifySighninMain.visibilityOfOptInCheckBox(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					if (localExecutionFlag == true)
						objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
					else
				...
				testStep = "Visibility of description under check box";
				visibilityStatus = objVerifySighninMain.visibilityOfDescription(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					if (localExecutionFlag == true)
						objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
					else
