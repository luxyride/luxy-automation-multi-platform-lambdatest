...
public class DEV_TC_1851_VerifyTheAvailabilityOfColumnsInPaymentsDashboardPageInTAPortal_Test extends TestBase {
	...
	DEV_TC_1851_VerifyTheAvailabilityOfColumnsInPaymentsDashboardPageInTAPortal_Main objVerifySighninMain;
	DEV_TC_1851_VerifyTheAvailabilityOfColumnsInPaymentsDashboardPageInTAPortal_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1851_VerifyTheAvailabilityOfColumnsInPaymentsDashboardPageInTAPortal_Main(
					driver);
			objVerifySighninTest = new DEV_TC_1851_VerifyTheAvailabilityOfColumnsInPaymentsDashboardPageInTAPortal_Test();
			objTestBase = new TestBase();
