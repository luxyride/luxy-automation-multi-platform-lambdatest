...
public class DEV_TC_1890_VerifyTheAvailabilityOfPaymentMethodsInTravelAgentPortal_Test extends TestBase {
	...
	DEV_TC_1890_VerifyTheAvailabilityOfPaymentMethodsInTravelAgentPortal_Main objVerifySighninMain;
	DEV_TC_1890_VerifyTheAvailabilityOfPaymentMethodsInTravelAgentPortal_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1890_VerifyTheAvailabilityOfPaymentMethodsInTravelAgentPortal_Main(driver);
			objVerifySighninTest = new DEV_TC_1890_VerifyTheAvailabilityOfPaymentMethodsInTravelAgentPortal_Test();
			objTestBase = new TestBase();
