...
public class DEV_TC_1980_VerifyTheCvvValidationWhenWeBookARideUsingSavedCardTravelAgentPortal_Test extends TestBase {
	...
	DEV_TC_1980_VerifyTheCvvValidationWhenWeBookARideUsingSavedCardTravelAgentPortal_Main objVerifySighninMain;
	DEV_TC_1980_VerifyTheCvvValidationWhenWeBookARideUsingSavedCardTravelAgentPortal_Test objVerifySighninTest;
	...
	public void VerifyLogInPageOfTravelAgentWithValidCredentials_Test() throws Exception {
		try {
			...
			objVerifySighninMain = new DEV_TC_1980_VerifyTheCvvValidationWhenWeBookARideUsingSavedCardTravelAgentPortal_Main(
					driver);
			objVerifySighninTest = new DEV_TC_1980_VerifyTheCvvValidationWhenWeBookARideUsingSavedCardTravelAgentPortal_Test();
			objTestBase = new TestBase();
	...
	public String vechileBooking(String scenario, String testStatus) throws Exception {
		try {
			...
			visibilityStatus = objVerifySighninMain.visibilityOfCvvField(visibilityStatus);
			objTestBase.defaultWaitTime(2000);
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)
					objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
			...
			objVerifySighninMain.enterCvvInput();
			objTestBase.defaultWaitTime(3000);
