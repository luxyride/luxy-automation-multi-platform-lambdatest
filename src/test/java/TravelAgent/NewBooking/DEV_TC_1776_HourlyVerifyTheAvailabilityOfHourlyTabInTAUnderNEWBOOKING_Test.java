...
public class DEV_TC_1776_HourlyVerifyTheAvailabilityOfHourlyTabInTAUnderNEWBOOKING_Test extends TestBase {
	...
	DEV_TC_1776_HourlyVerifyTheAvailabilityOfHourlyTabInTAUnderNEWBOOKING_Main objVerifySighninMain;
	DEV_TC_1776_HourlyVerifyTheAvailabilityOfHourlyTabInTAUnderNEWBOOKING_Test objVerifySighninTest;
	...
	public void VerifyLogInPageOfTravelAgentWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1776_HourlyVerifyTheAvailabilityOfHourlyTabInTAUnderNEWBOOKING_Main(driver);
			objVerifySighninTest = new DEV_TC_1776_HourlyVerifyTheAvailabilityOfHourlyTabInTAUnderNEWBOOKING_Test();
			objTestBase = new TestBase();
