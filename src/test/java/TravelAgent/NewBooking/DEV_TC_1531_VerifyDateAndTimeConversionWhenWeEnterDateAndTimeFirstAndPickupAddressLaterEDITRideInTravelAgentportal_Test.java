...
public class DEV_TC_1531_VerifyDateAndTimeConversionWhenWeEnterDateAndTimeFirstAndPickupAddressLaterEDITRideInTravelAgentportal_Test
		extends TestBase {
	String tripID;
	String currURL;
	...
	DEV_TC_1531_VerifyDateAndTimeConversionWhenWeEnterDateAndTimeFirstAndPickupAddressLaterEDITRideInTravelAgentportal_Main objVerifyEditDetails_Main;
	DEV_TC_1531_VerifyDateAndTimeConversionWhenWeEnterDateAndTimeFirstAndPickupAddressLaterEDITRideInTravelAgentportal_Test objVerifyEditDetails_Test;
	...
	public void verificationOfRideEditDetailsFromDispatchSite() throws Exception {
		try {
			...
			objVerifyEditDetails_Main = new DEV_TC_1531_VerifyDateAndTimeConversionWhenWeEnterDateAndTimeFirstAndPickupAddressLaterEDITRideInTravelAgentportal_Main(
					driver);
			objVerifyEditDetails_Test = new DEV_TC_1531_VerifyDateAndTimeConversionWhenWeEnterDateAndTimeFirstAndPickupAddressLaterEDITRideInTravelAgentportal_Test();
			objTestBase = new TestBase();
			...
			testStep = "Verify TA Portal Launch Homepage";
