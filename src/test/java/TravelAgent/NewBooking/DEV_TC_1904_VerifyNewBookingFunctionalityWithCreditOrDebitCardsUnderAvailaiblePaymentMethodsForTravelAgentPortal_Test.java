...
public class DEV_TC_1904_VerifyNewBookingFunctionalityWithCreditOrDebitCardsUnderAvailaiblePaymentMethodsForTravelAgentPortal_Test extends TestBase {
	...
	DEV_TC_1904_VerifyNewBookingFunctionalityWithCreditOrDebitCardsUnderAvailaiblePaymentMethodsForTravelAgentPortal_Main objVerifySighninMain;
	DEV_TC_1904_VerifyNewBookingFunctionalityWithCreditOrDebitCardsUnderAvailaiblePaymentMethodsForTravelAgentPortal_Test objVerifySighninTest;
	...
	public void VerifyLogInPageOfTravelAgentWithValidCredentials_Test() throws Exception {
		try {
			...
			objVerifySighninMain = new DEV_TC_1904_VerifyNewBookingFunctionalityWithCreditOrDebitCardsUnderAvailaiblePaymentMethodsForTravelAgentPortal_Main(driver);
			objVerifySighninTest = new DEV_TC_1904_VerifyNewBookingFunctionalityWithCreditOrDebitCardsUnderAvailaiblePaymentMethodsForTravelAgentPortal_Test();
			objTestBase = new TestBase();
