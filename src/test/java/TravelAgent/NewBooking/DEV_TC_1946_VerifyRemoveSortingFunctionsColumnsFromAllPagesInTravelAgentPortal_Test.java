...
public class DEV_TC_1946_VerifyRemoveSortingFunctionsColumnsFromAllPagesInTravelAgentPortal_Test extends TestBase {
	...
	DEV_TC_1946_VerifyRemoveSortingFunctionsColumnsFromAllPagesInTravelAgentPortal_Main objVerifySighninMain;
	DEV_TC_1946_VerifyRemoveSortingFunctionsColumnsFromAllPagesInTravelAgentPortal_Test objVerifySighninTest;
	...
	public void VerifySignInWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1946_VerifyRemoveSortingFunctionsColumnsFromAllPagesInTravelAgentPortal_Main(
					driver);
			objVerifySighninTest = new DEV_TC_1946_VerifyRemoveSortingFunctionsColumnsFromAllPagesInTravelAgentPortal_Test();
			objTestBase = new TestBase();
			...
			if (testStatus == "PASSED") {
				...
				objTestBase.defaultWaitTime(1000);
				objVerifySighninMain.clickOnAllRides();
				objTestBase.defaultWaitTime(3000);

				testStep = "verify Visibility of Sorting functionality for certain columns IN All Rides Page";
				visibilityStatus = objVerifySighninMain.visibilityOfRemovedSortingFunctionality(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					if (localExecutionFlag == true)
						objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
					else
				...
				objTestBase.defaultWaitTime(1000);
				objVerifySighninMain.clickOnInProgressRides();
				objTestBase.defaultWaitTime(3000);
				
				
				testStep = "verify Visibility of Sorting functionality for certain columns IN Progress Rides Page";
				visibilityStatus = objVerifySighninMain.visibilityOfRemovedSortingFunctionality(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					if (localExecutionFlag == true)
						objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
				...
				objTestBase.defaultWaitTime(1000);
				objVerifySighninMain.clickOnUpComingRides();
				objTestBase.defaultWaitTime(3000);
				
				testStep = "verify Visibility of Sorting functionality for certain columns IN UpComing Rides Page";
				visibilityStatus = objVerifySighninMain.visibilityOfRemovedSortingFunctionality(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					if (localExecutionFlag == true)
						objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
				...
				objTestBase.defaultWaitTime(1000);
				objVerifySighninMain.clickOnAvailableRides();
				objTestBase.defaultWaitTime(3000);
				
				testStep = "verify Visibility of Sorting functionality for certain columns IN Available Rides Page";
				visibilityStatus = objVerifySighninMain.visibilityOfRemovedSortingFunctionality(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					if (localExecutionFlag == true)
						objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
				...
				objTestBase.defaultWaitTime(1000);
				objVerifySighninMain.clickOnCancelledRides();
				objTestBase.defaultWaitTime(3000);
				
				testStep = "verify Visibility of Sorting functionality for certain columns IN Cancelled Rides Page";
				visibilityStatus = objVerifySighninMain.visibilityOfRemovedSortingFunctionality(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					if (localExecutionFlag == true)
						objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
