...
public class DEV_TC_1152_VerifyNewBookingFunctionalityInTravelAgentSite_Test extends TestBase {
	...
	DEV_TC_1152_VerifyNewBookingFunctionalityInTravelAgentSite_Main objVerifySighninMain;
	DEV_TC_1152_VerifyNewBookingFunctionalityInTravelAgentSite_Test objVerifySighninTest;
	...
	public void VerifyLogInPageOfTravelAgentWithValidCredentials_Test() throws Exception {
		try {
			...
			objVerifySighninMain = new DEV_TC_1152_VerifyNewBookingFunctionalityInTravelAgentSite_Main(driver);
			objVerifySighninTest = new DEV_TC_1152_VerifyNewBookingFunctionalityInTravelAgentSite_Test();
			objTestBase = new TestBase();
