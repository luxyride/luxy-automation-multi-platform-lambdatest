...
public class DEV_TC_1928_VerfiyPayNowUpdateButtonIsDisabledForPaymentErrorRidesTravelAgentPortal_Test extends TestBase {
	...
	DEV_TC_1928_VerfiyPayNowUpdateButtonIsDisabledForPaymentErrorRidesTravelAgentPortal_Main objVerifySighninMain;
	DEV_TC_1928_VerfiyPayNowUpdateButtonIsDisabledForPaymentErrorRidesTravelAgentPortal_Test objVerifySighninTest;
	...
	public void VerifyLogInPageOfTravelAgentWithValidCredentials_Test() throws Exception {
		try {
			...
			objVerifySighninMain = new DEV_TC_1928_VerfiyPayNowUpdateButtonIsDisabledForPaymentErrorRidesTravelAgentPortal_Main(driver);
			objVerifySighninTest = new DEV_TC_1928_VerfiyPayNowUpdateButtonIsDisabledForPaymentErrorRidesTravelAgentPortal_Test();
			objTestBase = new TestBase();
	...
	public String vechileBooking(String scenario, String testStatus) throws Exception {
		try {
			...
			objVerifySighninMain.editRideDetails();
			objTestBase.defaultWaitTime(3000);
			...
			visibilityStatus = objVerifySighninMain.visibilityOfUpdateRideButtonDisabled(visibilityStatus);
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)	objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);	else	lambdaTestStatusUpdate("passed", testStep);
				testStatus = "PASSED";
			} else {
			...
			objVerifySighninMain.clickonArrivalMeetGreet();
			objTestBase.defaultWaitTime(2000);
			objVerifySighninMain.enterArrivalMeetGreetDetails();
			objTestBase.defaultWaitTime(1000);
			...
			visibilityStatus = objVerifySighninMain.visibilityOfPayNowButtonDisabled(visibilityStatus);
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)	objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);	else	lambdaTestStatusUpdate("passed", testStep);
				testStatus = "PASSED";
			} else {
