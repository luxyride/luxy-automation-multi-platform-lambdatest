...
public class DEV_TC_1905_VerifyNewBookingFunctionalityWithGooglePayUnderAvailaiblePaymentMethodsForTravelAgentPortal_Test
		extends TestBase {
	...
	DEV_TC_1905_VerifyNewBookingFunctionalityWithGooglePayUnderAvailaiblePaymentMethodsForTravelAgentPortal_Main objVerifySighninMain;
	DEV_TC_1905_VerifyNewBookingFunctionalityWithGooglePayUnderAvailaiblePaymentMethodsForTravelAgentPortal_Test objVerifySighninTest;
	...
	public void VerifyLogInPageOfTravelAgentWithValidCredentials_Test() throws Exception {
		try {
			...
			objVerifySighninMain = new DEV_TC_1905_VerifyNewBookingFunctionalityWithGooglePayUnderAvailaiblePaymentMethodsForTravelAgentPortal_Main(
					driver);
			objVerifySighninTest = new DEV_TC_1905_VerifyNewBookingFunctionalityWithGooglePayUnderAvailaiblePaymentMethodsForTravelAgentPortal_Test();
			objTestBase = new TestBase();
	...
	public String vechileBooking(String scenario, String testStatus) throws Exception {
		try {
			...
			visibilityStatus = objVerifySighninMain.verifyGooglePayOptionVisibility(visibilityStatus);
			objTestBase.defaultWaitTime(2000);
			
			String parentWindow = driver.getWindowHandle();
			objTestBase.defaultWaitTime(1000);
			
			objVerifySighninMain.clickOnpayingWithgooglePayOption();
			objTestBase.defaultWaitTime(10000);
			
			testStep = "Verification of Google Payment Continue popup";
			visibilityStatus = objVerifySighninMain.verifyContinueBtnVisibility(parentWindow, visibilityStatus);
			objTestBase.defaultWaitTime(2000);
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)
					objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
			...
			objVerifySighninMain.clickOnContinueButton();
			objTestBase.defaultWaitTime(10000);
