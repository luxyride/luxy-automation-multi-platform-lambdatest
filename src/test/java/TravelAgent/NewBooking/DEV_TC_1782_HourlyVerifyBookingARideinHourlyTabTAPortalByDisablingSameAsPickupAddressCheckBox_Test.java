...
public class DEV_TC_1782_HourlyVerifyBookingARideinHourlyTabTAPortalByDisablingSameAsPickupAddressCheckBox_Test extends TestBase {
	...
	DEV_TC_1782_HourlyVerifyBookingARideinHourlyTabTAPortalByDisablingSameAsPickupAddressCheckBox_Main objVerifySighninMain;
	DEV_TC_1782_HourlyVerifyBookingARideinHourlyTabTAPortalByDisablingSameAsPickupAddressCheckBox_Test objVerifySighninTest;
	...
	public void VerifyLogInPageOfTravelAgentWithValidCredentials_Test() throws Exception {
		try {
			...
			objVerifySighninMain = new DEV_TC_1782_HourlyVerifyBookingARideinHourlyTabTAPortalByDisablingSameAsPickupAddressCheckBox_Main(driver);
			objVerifySighninTest = new DEV_TC_1782_HourlyVerifyBookingARideinHourlyTabTAPortalByDisablingSameAsPickupAddressCheckBox_Test();
			objTestBase = new TestBase();
	...
	public String vechileBooking(String scenario, String testStatus) throws Exception {
		try {
			...
			objTestBase.defaultWaitTime(3000);
			objVerifySighninMain.unUncheckSameAsPickUp();
			objTestBase.defaultWaitTime(3000);
