...
public class DEV_TC_1318_VerifyRideBookingWhenZoneTypeAsCity_TravelAgent_Test extends TestBase {
	...
	DEV_TC_1318_VerifyRideBookingWhenZoneTypeAsCity_TravelAgent_Main objVerifyEditRidesZone_Main;
	DEV_TC_1318_VerifyRideBookingWhenZoneTypeAsCity_TravelAgent_Test objVerifyEditRidesZone_Test;
	...
	public void verifyRideEditWhenZoneTypeAsState() throws Exception {
		try {
			...
			objVerifyEditRidesZone_Main = new DEV_TC_1318_VerifyRideBookingWhenZoneTypeAsCity_TravelAgent_Main(driver);
			objVerifyEditRidesZone_Test = new DEV_TC_1318_VerifyRideBookingWhenZoneTypeAsCity_TravelAgent_Test();
			objTestBase = new TestBase();
