...
public class DEV_TC_1239_VerifyTheAvailabilityOfCorporateSelectionSectionInNewBookingFlow_Test extends TestBase {
	...
	DEV_TC_1239_VerifyTheAvailabilityOfCorporateSelectionSectionInNewBookingFlow_Main objVerifySighninMain;
	DEV_TC_1239_VerifyTheAvailabilityOfCorporateSelectionSectionInNewBookingFlow_Test objVerifySighninTest;
	UpdateExtentReportResults objupdateResults;
	TestBase objTestBase;

	@BeforeClass(groups = "TravelAgent.NewBookings")
	@Parameters({"browser"})
	...
	@Test(groups = "TravelAgent.NewBookings")
	public void VerifyTheAvailabilityOfCorporateSelectionSectionInNewBookingFlow() throws Exception {

		try {
			action = new Actions(driver);
			objVerifySighninMain = new DEV_TC_1239_VerifyTheAvailabilityOfCorporateSelectionSectionInNewBookingFlow_Main(
					driver);
			objVerifySighninTest = new DEV_TC_1239_VerifyTheAvailabilityOfCorporateSelectionSectionInNewBookingFlow_Test();
			objTestBase = new TestBase();
			...
			if (testStatus == "PASSED") {
				...
				testStep = "verify the Corporate Selecction Section In Newbooking Flow";
				visibilityStatus = objVerifySighninMain
						.visibilityOfCorporateSelecctionSectionInNewbookingFlow(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					if (localExecutionFlag == true)	objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);	else	browserStackTestStatusUpdate("passed", testStep);
					testStatus = "PASSED";
				} else {
	...
	@AfterClass(groups = "TravelAgent.NewBookings")
