...
public class DEV_TC_1226_VerifyTheAvailabilityOfTravelAgentTabInDispatchPortal_Test extends TestBase {
	...
	DEV_TC_1226_VerifyTheAvailabilityOfTravelAgentTabInDispatchPortal_Main objVerifySighninMain;
	DEV_TC_1226_VerifyTheAvailabilityOfTravelAgentTabInDispatchPortal_Test objVerifySighninTest;
	...
	public void verifyAvailabilityOfTravelAgentTabInDispatch() throws Exception {

		try {
			action = new Actions(driver);
			objVerifySighninMain = new DEV_TC_1226_VerifyTheAvailabilityOfTravelAgentTabInDispatchPortal_Main(driver);
			objVerifySighninTest = new DEV_TC_1226_VerifyTheAvailabilityOfTravelAgentTabInDispatchPortal_Test();
			objTestBase = new TestBase();
