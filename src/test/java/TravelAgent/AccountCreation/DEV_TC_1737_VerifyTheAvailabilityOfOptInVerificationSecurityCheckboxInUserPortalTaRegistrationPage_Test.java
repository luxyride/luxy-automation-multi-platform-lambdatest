...
public class DEV_TC_1737_VerifyTheAvailabilityOfOptInVerificationSecurityCheckboxInUserPortalTaRegistrationPage_Test extends TestBase {
	...
	DEV_TC_1737_VerifyTheAvailabilityOfOptInVerificationSecurityCheckboxInUserPortalTaRegistrationPage_Main objVerifyUITARegisMain;
	DEV_TC_1737_VerifyTheAvailabilityOfOptInVerificationSecurityCheckboxInUserPortalTaRegistrationPage_Test objVerifyUITARegisTest;
	...
	public void verificationOfTravelAgentRegistrationPage() throws Exception {
		try {
			...
			objVerifyUITARegisMain = new DEV_TC_1737_VerifyTheAvailabilityOfOptInVerificationSecurityCheckboxInUserPortalTaRegistrationPage_Main(driver);
			objVerifyUITARegisTest = new DEV_TC_1737_VerifyTheAvailabilityOfOptInVerificationSecurityCheckboxInUserPortalTaRegistrationPage_Test();
			objTestBase = new TestBase();
	...
	private void verifyTravelAgentReistrationForm(String scenario) {
		try {
			...
			testStep = "Verification of OPT in check box in Travel Agent Registration form - " + scenario;
			visibilityStatus = objVerifyUITARegisMain.visibilityOfOptInCheckBox(visibilityStatus);
			objTestBase.defaultWaitTime(2000);
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)	objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);	else	lambdaTestStatusUpdate("passed", testStep);
				testStatus = "PASSED";
