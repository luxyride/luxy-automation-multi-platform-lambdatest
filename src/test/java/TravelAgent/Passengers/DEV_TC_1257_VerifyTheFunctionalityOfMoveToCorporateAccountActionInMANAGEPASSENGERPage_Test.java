...
public class DEV_TC_1257_VerifyTheFunctionalityOfMoveToCorporateAccountActionInMANAGEPASSENGERPage_Test
		extends TestBase {
	...
	DEV_TC_1257_VerifyTheFunctionalityOfMoveToCorporateAccountActionInMANAGEPASSENGERPage_Main objVerifySighninMain;
	DEV_TC_1257_VerifyTheFunctionalityOfMoveToCorporateAccountActionInMANAGEPASSENGERPage_Test objVerifySighninTest;
	...
	public void VerifythefucntionalityofMovetoCorporateAcountinManagePassengerPage_Test() throws Exception {

		try {
			action = new Actions(driver);
			objVerifySighninMain = new DEV_TC_1257_VerifyTheFunctionalityOfMoveToCorporateAccountActionInMANAGEPASSENGERPage_Main(
					driver);
			objVerifySighninTest = new DEV_TC_1257_VerifyTheFunctionalityOfMoveToCorporateAccountActionInMANAGEPASSENGERPage_Test();
			objTestBase = new TestBase();
			...
			if (testStatus == "PASSED") {
				...
				objTestBase.defaultWaitTime(3000);
				objVerifySighninMain.clickonMoveBtn();
				objTestBase.defaultWaitTime(3000);

				testStep = "visibility of cancel button  ";
				...
				objVerifySighninMain.clickOnCancelBtn();
				objTestBase.defaultWaitTime(3000);
				testStep = "Verification of Manage passenegr page";
				visibilityStatus = objVerifySighninMain.visibilityOfManagePassengerPage(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
				...
				objVerifySighninMain.clickonMoveBtn();
				objTestBase.defaultWaitTime(3000);
				objVerifySighninMain.enterCorpInput();
				objTestBase.defaultWaitTime(3000);

				testStep = "visibility of Move Button ";
				visibilityStatus = objVerifySighninMain.visibilityOfMoveBtn(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					if (localExecutionFlag == true)	objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);	else	browserStackTestStatusUpdate("passed", testStep);
					testStatus = "PASSED";
				} else {
				...
				objVerifySighninMain.clickOnconfirmMove();
				objTestBase.defaultWaitTime(3000);
				testStep = "visibility of success messsage after moving to corporate";
