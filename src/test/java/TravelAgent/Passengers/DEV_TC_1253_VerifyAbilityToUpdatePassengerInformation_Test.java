...
public class DEV_TC_1253_VerifyAbilityToUpdatePassengerInformation_Test extends TestBase {
	...
	DEV_TC_1253_VerifyAbilityToUpdatePassengerInformation_Main objVerifySighninMain;
	DEV_TC_1253_VerifyAbilityToUpdatePassengerInformation_Test objVerifySighninTest;
	...
	public void VerifyUIOfPassengerRegistrationFormInTravelAgentSite_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1253_VerifyAbilityToUpdatePassengerInformation_Main(driver);
			objVerifySighninTest = new DEV_TC_1253_VerifyAbilityToUpdatePassengerInformation_Test();
			objTestBase = new TestBase();
			...
			testStep = "Verification laucning Travel Agent Page";
			...
			if (testStatus == "PASSED") {
				...
				testStep = "visibility of passenger details page in edit mode with the registered Passenger.";
				visibilityStatus = objVerifySighninMain.visibilityOfPassengerdetailsPage(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					if (localExecutionFlag == true)	objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);	else	browserStackTestStatusUpdate("passed", testStep);
					testStatus = "PASSED";
				} else {
				...
				testStep = "visibility of passenger details page in edit mode ";
				...
				objTestBase.defaultWaitTime(3000);
				testStep = "Verification of Manage passenegr page navigation after clicking on Cancel";
				visibilityStatus = objVerifySighninMain.visibilityOfManagePassengerPage(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					if (localExecutionFlag == true)	objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);	else	browserStackTestStatusUpdate("passed", testStep);
					testStatus = "PASSED";
				...
				objTestBase.defaultWaitTime(4000);
				testStep = "visibility of passenger details page in edit mode ";
				visibilityStatus = objVerifySighninMain.visibilityOfSubmitBtn(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					if (localExecutionFlag == true)	objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);	else	browserStackTestStatusUpdate("passed", testStep);
					testStatus = "PASSED";
				} else {
				...
				objVerifySighninMain.clickOnSubmitBtn();
				objTestBase.defaultWaitTime(1000);
				testStep = "visibility of success messsage displayed.?";
