...
public class DEV_TC_1146_VerifyTheLoginPageOfTravelAgentWithValidCredentials_Test extends TestBase {
	...
	DEV_TC_1146_VerifyTheLoginPageOfTravelAgentWithValidCredentials_Main objVerifySighninMain;
	DEV_TC_1146_VerifyTheLoginPageOfTravelAgentWithValidCredentials_Test objVerifySighninTest;
	...
	public void VerifyLogInPageOfTravelAgentWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1146_VerifyTheLoginPageOfTravelAgentWithValidCredentials_Main(driver);
			objVerifySighninTest = new DEV_TC_1146_VerifyTheLoginPageOfTravelAgentWithValidCredentials_Test();
			objTestBase = new TestBase();
