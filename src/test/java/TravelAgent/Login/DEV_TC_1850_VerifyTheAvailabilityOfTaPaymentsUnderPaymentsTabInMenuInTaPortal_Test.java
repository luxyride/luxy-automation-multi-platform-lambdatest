...
public class DEV_TC_1850_VerifyTheAvailabilityOfTaPaymentsUnderPaymentsTabInMenuInTaPortal_Test extends TestBase {
	...
	DEV_TC_1850_VerifyTheAvailabilityOfTaPaymentsUnderPaymentsTabInMenuInTaPortal_Main objVerifySighninMain;
	DEV_TC_1850_VerifyTheAvailabilityOfTaPaymentsUnderPaymentsTabInMenuInTaPortal_Test objVerifySighninTest;
	...
	public void VerifyLogInPageOfTravelAgentWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1850_VerifyTheAvailabilityOfTaPaymentsUnderPaymentsTabInMenuInTaPortal_Main(driver);
			objVerifySighninTest = new DEV_TC_1850_VerifyTheAvailabilityOfTaPaymentsUnderPaymentsTabInMenuInTaPortal_Test();
			objTestBase = new TestBase();
