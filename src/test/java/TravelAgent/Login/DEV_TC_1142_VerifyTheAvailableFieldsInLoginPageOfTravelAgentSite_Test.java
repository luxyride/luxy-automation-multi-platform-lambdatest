...
public class DEV_TC_1142_VerifyTheAvailableFieldsInLoginPageOfTravelAgentSite_Test extends TestBase {
	...
	DEV_TC_1142_VerifyTheAvailableFieldsInLoginPageOfTravelAgentSite_Main objVerifySighninMain;
	DEV_TC_1142_VerifyTheAvailableFieldsInLoginPageOfTravelAgentSite_Test objVerifySighninTest;
	...
	public void VerifyLogInPageOfTravelAgentWithValidCredentials_Test() throws Exception {
		...
		try {
			...
			objVerifySighninMain = new DEV_TC_1142_VerifyTheAvailableFieldsInLoginPageOfTravelAgentSite_Main(driver);
			objVerifySighninTest = new DEV_TC_1142_VerifyTheAvailableFieldsInLoginPageOfTravelAgentSite_Test();
			objTestBase = new TestBase();
