...
public class DEV_TC_1838_VerifyTheFieldValidationOfAvailableFieldsInCorporateRegistrationPage_Test
		extends TestBase {
	String currURL;
	...
	DEV_TC_1838_VerifyTheFieldValidationOfAvailableFieldsInCorporateRegistrationPage_Main objVerifyRegisCorpMain;
	DEV_TC_1838_VerifyTheFieldValidationOfAvailableFieldsInCorporateRegistrationPage_Test objVerifyRegisCorpTest;
	...
	public void verifyRegistrationCorporate() {
		try {
			...
			objVerifyRegisCorpMain = new DEV_TC_1838_VerifyTheFieldValidationOfAvailableFieldsInCorporateRegistrationPage_Main(
					driver);
			objVerifyRegisCorpTest = new DEV_TC_1838_VerifyTheFieldValidationOfAvailableFieldsInCorporateRegistrationPage_Test();
			objTestBase = new TestBase();
			...
			utillLogger.info(testStep + " - " + testStatus);
			testStep = "Verify visibility of Corporate module from Homepage Header";
			...
			if (visibilityStatus.booleanValue() == true) {
				visibilityStatus = objVerifyRegisCorpMain.verifyTheAvailabilityOfTextFieldsInCorporateForm(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					screenshotPath = getScreenshot(driver, "VerifyCorporate");
					if (localExecutionFlag == true)
						objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
