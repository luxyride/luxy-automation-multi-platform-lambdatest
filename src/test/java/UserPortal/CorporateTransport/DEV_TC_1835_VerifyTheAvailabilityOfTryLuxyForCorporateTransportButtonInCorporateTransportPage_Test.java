...
public class DEV_TC_1835_VerifyTheAvailabilityOfTryLuxyForCorporateTransportButtonInCorporateTransportPage_Test
		extends TestBase {
	String currURL;
	...
	DEV_TC_1835_VerifyTheAvailabilityOfTryLuxyForCorporateTransportButtonInCorporateTransportPage_Main objVerifyRegisCorpMain;
	DEV_TC_1835_VerifyTheAvailabilityOfTryLuxyForCorporateTransportButtonInCorporateTransportPage_Test objVerifyRegisCorpTest;
	...
	public void verifyRegistrationCorporate() {
		try {
			...
			objVerifyRegisCorpMain = new DEV_TC_1835_VerifyTheAvailabilityOfTryLuxyForCorporateTransportButtonInCorporateTransportPage_Main(
					driver);
			objVerifyRegisCorpTest = new DEV_TC_1835_VerifyTheAvailabilityOfTryLuxyForCorporateTransportButtonInCorporateTransportPage_Test();
			objTestBase = new TestBase();
