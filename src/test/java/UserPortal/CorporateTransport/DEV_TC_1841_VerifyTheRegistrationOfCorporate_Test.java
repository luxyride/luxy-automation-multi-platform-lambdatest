...
public class DEV_TC_1841_VerifyTheRegistrationOfCorporate_Test extends TestBase {
	String currURL;
	...
	DEV_TC_1841_VerifyTheRegistrationOfCorporate_Main objVerifyRegisCorpMain;
	DEV_TC_1841_VerifyTheRegistrationOfCorporate_Test objVerifyRegisCorpTest;
	...
	public void verifyRegistrationCorporate() {
		try {
			...
			objVerifyRegisCorpMain = new DEV_TC_1841_VerifyTheRegistrationOfCorporate_Main(driver);
			objVerifyRegisCorpTest = new DEV_TC_1841_VerifyTheRegistrationOfCorporate_Test();
			objTestBase = new TestBase();
