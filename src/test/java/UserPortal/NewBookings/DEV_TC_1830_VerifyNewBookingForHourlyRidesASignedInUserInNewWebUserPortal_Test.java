...
public class DEV_TC_1830_VerifyNewBookingForHourlyRidesASignedInUserInNewWebUserPortal_Test extends TestBase {
	...
	DEV_TC_1830_VerifyNewBookingForHourlyRidesASignedInUserInNewWebUserPortal_Main objVerifyNewBookingMain;
	DEV_TC_1830_VerifyNewBookingForHourlyRidesASignedInUserInNewWebUserPortal_Test objVerifyNewBookingTest;
	...
	public void ActivationOfNewUserAfterRegistration() throws Exception {
		try {
			...
			objVerifyNewBookingMain = new DEV_TC_1830_VerifyNewBookingForHourlyRidesASignedInUserInNewWebUserPortal_Main(
					driver);
			objVerifyNewBookingTest = new DEV_TC_1830_VerifyNewBookingForHourlyRidesASignedInUserInNewWebUserPortal_Test();
			objTestBase = new TestBase();
