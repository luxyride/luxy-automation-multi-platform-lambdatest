...
public class DEV_TC_2345_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInWebUserPortal_Test extends TestBase {
	...
	DEV_TC_2345_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInWebUserPortal_Main objVerifyNewBookingMain;
	DEV_TC_2345_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInWebUserPortal_Test objVerifyNewBookingTest;
	...
	public void ActivationOfNewUserAfterRegistration() throws Exception {
		try {
			...
			objVerifyNewBookingMain = new DEV_TC_2345_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInWebUserPortal_Main(
					driver);
			objVerifyNewBookingTest = new DEV_TC_2345_VerifyTheMaximumCharacterLimitForTheLastNameOfPassengerDetailsInWebUserPortal_Test();
			objTestBase = new TestBase();
