...
public class DEV_TC_1827_VerifyNewBookingForIndividualRidesAsGuestUserInNewWebUserPortal_Test extends TestBase {
	...
	DEV_TC_1827_VerifyNewBookingForIndividualRidesAsGuestUserInNewWebUserPortal_Main objVerifyNewBookingMain;
	DEV_TC_1827_VerifyNewBookingForIndividualRidesAsGuestUserInNewWebUserPortal_Test objVerifyNewBookingTest;
	...
	public void ActivationOfNewUserAfterRegistration() throws Exception {
		try {
			...
			objVerifyNewBookingMain = new DEV_TC_1827_VerifyNewBookingForIndividualRidesAsGuestUserInNewWebUserPortal_Main(
					driver);
			objVerifyNewBookingTest = new DEV_TC_1827_VerifyNewBookingForIndividualRidesAsGuestUserInNewWebUserPortal_Test();
			objTestBase = new TestBase();
