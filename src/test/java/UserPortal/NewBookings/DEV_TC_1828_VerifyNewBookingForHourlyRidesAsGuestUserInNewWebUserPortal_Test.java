...
public class DEV_TC_1828_VerifyNewBookingForHourlyRidesAsGuestUserInNewWebUserPortal_Test extends TestBase {
	...
	DEV_TC_1828_VerifyNewBookingForHourlyRidesAsGuestUserInNewWebUserPortal_Main objVerifyNewBookingMain;
	DEV_TC_1828_VerifyNewBookingForHourlyRidesAsGuestUserInNewWebUserPortal_Test objVerifyNewBookingTest;
	...
	public void ActivationOfNewUserAfterRegistration() throws Exception {
		try {
			...
			objVerifyNewBookingMain = new DEV_TC_1828_VerifyNewBookingForHourlyRidesAsGuestUserInNewWebUserPortal_Main(
					driver);
			objVerifyNewBookingTest = new DEV_TC_1828_VerifyNewBookingForHourlyRidesAsGuestUserInNewWebUserPortal_Test();
			objTestBase = new TestBase();
