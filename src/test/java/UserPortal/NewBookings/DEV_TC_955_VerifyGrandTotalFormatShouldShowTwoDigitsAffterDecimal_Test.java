...
public class DEV_TC_955_VerifyGrandTotalFormatShouldShowTwoDigitsAffterDecimal_Test extends TestBase {
	...
	DEV_TC_955_VerifyGrandTotalFormatShouldShowTwoDigitsAffterDecimal_Main objVerifyNewBookingMain;
	DEV_TC_955_VerifyGrandTotalFormatShouldShowTwoDigitsAffterDecimal_Test objVerifyNewBookingTest;
	...
	public void ActivationOfNewUserAfterRegistration() throws Exception {
		try {
			...
			objVerifyNewBookingMain = new DEV_TC_955_VerifyGrandTotalFormatShouldShowTwoDigitsAffterDecimal_Main(
					driver);
			objVerifyNewBookingTest = new DEV_TC_955_VerifyGrandTotalFormatShouldShowTwoDigitsAffterDecimal_Test();
			objTestBase = new TestBase();
	...
	public void continueBookingFlow(String scenario, String testStatus) {
		try {
			...
			visibilityStatus = objVerifyNewBookingMain.verifyVisibilityOfDecimalFormat(visibilityStatus);
			objTestBase.defaultWaitTime(4000);
			driver.navigate().refresh();
			utillLogger.info(testStep + " - " + testStatus);
		} catch (Exception ex) {
