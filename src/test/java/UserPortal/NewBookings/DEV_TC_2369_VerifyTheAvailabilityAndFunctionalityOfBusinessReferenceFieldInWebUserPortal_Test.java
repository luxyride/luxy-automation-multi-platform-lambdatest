...
public class DEV_TC_2369_VerifyTheAvailabilityAndFunctionalityOfBusinessReferenceFieldInWebUserPortal_Test extends TestBase {
	...
	DEV_TC_2369_VerifyTheAvailabilityAndFunctionalityOfBusinessReferenceFieldInWebUserPortal_Main objVerifyNewBookingMain;
	DEV_TC_2369_VerifyTheAvailabilityAndFunctionalityOfBusinessReferenceFieldInWebUserPortal_Test objVerifyNewBookingTest;
	...
	public void ActivationOfNewUserAfterRegistration() throws Exception {
		try {
			...
			objVerifyNewBookingMain = new DEV_TC_2369_VerifyTheAvailabilityAndFunctionalityOfBusinessReferenceFieldInWebUserPortal_Main(
					driver);
			objVerifyNewBookingTest = new DEV_TC_2369_VerifyTheAvailabilityAndFunctionalityOfBusinessReferenceFieldInWebUserPortal_Test();
			objTestBase = new TestBase();
	...
	public void continueBookingFlow(String scenario, String testStatus) {
		try {
			...
			testStep = "Verification of Booking For 'Personal' is selected by default now change to Bussiness for the scenario " + scenario
					+ " from Ride Booking Details Page";
			visibilityStatus = objVerifyNewBookingMain.verifyBookingForBussinessSelected(visibilityStatus);
			if (visibilityStatus.booleanValue() == true)
				if (localExecutionFlag == true)
					objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
				else
			...
			objTestBase.defaultWaitTime(2000);
			objVerifyNewBookingMain.enterBussinessInput();
			objTestBase.defaultWaitTime(2000);
