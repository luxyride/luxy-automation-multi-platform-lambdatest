...
public class DEV_TC_2033_VerifyTheAvailabilityOfUpdatedTextInDriverandPartnerPage_Test extends TestBase {
	String currURL;
	...
	DEV_TC_2033_VerifyTheAvailabilityOfUpdatedTextInDriverandPartnerPage_Main objVerifyRegisCorpMain;
	DEV_TC_2033_VerifyTheAvailabilityOfUpdatedTextInDriverandPartnerPage_Test objVerifyRegisCorpTest;
	...
	public void verifyRegistrationCorporate() {
		try {
			...
			objVerifyRegisCorpMain = new DEV_TC_2033_VerifyTheAvailabilityOfUpdatedTextInDriverandPartnerPage_Main(
					driver);
			objVerifyRegisCorpTest = new DEV_TC_2033_VerifyTheAvailabilityOfUpdatedTextInDriverandPartnerPage_Test();
			objTestBase = new TestBase();
			...
			if (visibilityStatus.booleanValue() == true) {
				visibilityStatus = objVerifyRegisCorpMain.verifyUpdatedText(visibilityStatus);
				if (visibilityStatus.booleanValue() == true) {
					screenshotPath = getScreenshot(driver, "VerifyCorporate");
					if (localExecutionFlag == true)
						objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
