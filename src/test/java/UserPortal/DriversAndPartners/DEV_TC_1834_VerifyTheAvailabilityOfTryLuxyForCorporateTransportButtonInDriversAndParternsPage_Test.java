...
public class DEV_TC_1834_VerifyTheAvailabilityOfTryLuxyForCorporateTransportButtonInDriversAndParternsPage_Test
		extends TestBase {
	String currURL;
	...
	DEV_TC_1834_VerifyTheAvailabilityOfTryLuxyForCorporateTransportButtonInDriversAndParternsPage_Main objVerifyRegisCorpMain;
	DEV_TC_1834_VerifyTheAvailabilityOfTryLuxyForCorporateTransportButtonInDriversAndParternsPage_Test objVerifyRegisCorpTest;
	...
	public void verifyRegistrationCorporate() {
		try {
			...
			objVerifyRegisCorpMain = new DEV_TC_1834_VerifyTheAvailabilityOfTryLuxyForCorporateTransportButtonInDriversAndParternsPage_Main(
					driver);
			objVerifyRegisCorpTest = new DEV_TC_1834_VerifyTheAvailabilityOfTryLuxyForCorporateTransportButtonInDriversAndParternsPage_Test();
			objTestBase = new TestBase();
