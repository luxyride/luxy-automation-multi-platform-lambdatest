...
public class DEV_TC_1840_VerifyTheRegistrationOfAffiliate_Test extends TestBase {
	String currURL;
	...
	public void verifyRegistrationCorporate() {
		try {
			...
			objVerifyRegisCorpMain = new DEV_TC_1840_VerifyTheRegistrationOfAffiliate_Main(driver);
