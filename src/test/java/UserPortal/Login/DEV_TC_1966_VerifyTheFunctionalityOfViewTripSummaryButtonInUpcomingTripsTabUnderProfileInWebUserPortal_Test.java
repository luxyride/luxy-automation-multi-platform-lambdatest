...
public class DEV_TC_1966_VerifyTheFunctionalityOfViewTripSummaryButtonInUpcomingTripsTabUnderProfileInWebUserPortal_Test extends TestBase {
	...
	DEV_TC_1966_VerifyTheFunctionalityOfViewTripSummaryButtonInUpcomingTripsTabUnderProfileInWebUserPortal_Main objVerifyNewBookingMain;
	DEV_TC_1966_VerifyTheFunctionalityOfViewTripSummaryButtonInUpcomingTripsTabUnderProfileInWebUserPortal_Test objVerifyNewBookingTest;
	...
	public void ActivationOfNewUserAfterRegistration() throws Exception {
		try {
			...
			objVerifyNewBookingMain = new DEV_TC_1966_VerifyTheFunctionalityOfViewTripSummaryButtonInUpcomingTripsTabUnderProfileInWebUserPortal_Main(
					driver);
			objVerifyNewBookingTest = new DEV_TC_1966_VerifyTheFunctionalityOfViewTripSummaryButtonInUpcomingTripsTabUnderProfileInWebUserPortal_Test();
			objTestBase = new TestBase();
