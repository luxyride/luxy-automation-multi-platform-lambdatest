...
public class DEV_TC_1983_VerifyContactUsPageInNewUserPortal_Test extends TestBase {
	...
	DEV_TC_1983_VerifyContactUsPageInNewUserPortal_Main objVerifyNewBookingMain;
	DEV_TC_1983_VerifyContactUsPageInNewUserPortal_Test objVerifyNewBookingTest;
	...
	public void ActivationOfNewUserAfterRegistration() throws Exception {
		try {
			...
			objVerifyNewBookingMain = new DEV_TC_1983_VerifyContactUsPageInNewUserPortal_Main(driver);
			objVerifyNewBookingTest = new DEV_TC_1983_VerifyContactUsPageInNewUserPortal_Test();
			objTestBase = new TestBase();
