...
public class DEV_TC_1968_VerifyTheFunctionalityOfCancelTripButtonByEnablingTripProtectionForAbove3Hours_WebUserPortal_Test extends TestBase {
	...
	DEV_TC_1968_VerifyTheFunctionalityOfCancelTripButtonByEnablingTripProtectionForAbove3Hours_WebUserPortal_Main objVerifyNewBookingMain;
	DEV_TC_1968_VerifyTheFunctionalityOfCancelTripButtonByEnablingTripProtectionForAbove3Hours_WebUserPortal_Test objVerifyNewBookingTest;
	...
	public void ActivationOfNewUserAfterRegistration() throws Exception {
		try {
			...
			objVerifyNewBookingMain = new DEV_TC_1968_VerifyTheFunctionalityOfCancelTripButtonByEnablingTripProtectionForAbove3Hours_WebUserPortal_Main(
					driver);
			objVerifyNewBookingTest = new DEV_TC_1968_VerifyTheFunctionalityOfCancelTripButtonByEnablingTripProtectionForAbove3Hours_WebUserPortal_Test();
			objTestBase = new TestBase();
	...
	public void continueBookingFlow(String scenario, String testStatus) {
		try {
			...
			objTestBase.defaultWaitTime(1000);
			objVerifyNewBookingMain.clickOnPastTrips();
			objTestBase.defaultWaitTime(2000);
