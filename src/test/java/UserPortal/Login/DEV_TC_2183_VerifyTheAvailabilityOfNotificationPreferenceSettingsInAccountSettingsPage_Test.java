...
public class DEV_TC_2183_VerifyTheAvailabilityOfNotificationPreferenceSettingsInAccountSettingsPage_Test extends TestBase {
	...
	DEV_TC_2183_VerifyTheAvailabilityOfNotificationPreferenceSettingsInAccountSettingsPage_Main objVerifyNewBookingMain;
	DEV_TC_2183_VerifyTheAvailabilityOfNotificationPreferenceSettingsInAccountSettingsPage_Test objVerifyNewBookingTest;
	...
	public void ActivationOfNewUserAfterRegistration() throws Exception {
		try {
			...
			objVerifyNewBookingMain = new DEV_TC_2183_VerifyTheAvailabilityOfNotificationPreferenceSettingsInAccountSettingsPage_Main(driver);
			objVerifyNewBookingTest = new DEV_TC_2183_VerifyTheAvailabilityOfNotificationPreferenceSettingsInAccountSettingsPage_Test();
			objTestBase = new TestBase();
