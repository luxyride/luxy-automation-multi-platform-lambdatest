...
public class DEV_TC_2189_VerifyTheAvailabilityOfFavoriteAddressesUnderMyAddressesMenu_Test extends TestBase {
	...
	DEV_TC_2189_VerifyTheAvailabilityOfFavoriteAddressesUnderMyAddressesMenu_Main objVerifyNewBookingMain;
	DEV_TC_2189_VerifyTheAvailabilityOfFavoriteAddressesUnderMyAddressesMenu_Test objVerifyNewBookingTest;
	...
	public void ActivationOfNewUserAfterRegistration() throws Exception {
		try {
			...
			objVerifyNewBookingMain = new DEV_TC_2189_VerifyTheAvailabilityOfFavoriteAddressesUnderMyAddressesMenu_Main(driver);
			objVerifyNewBookingTest = new DEV_TC_2189_VerifyTheAvailabilityOfFavoriteAddressesUnderMyAddressesMenu_Test();
			objTestBase = new TestBase();
			...
			objTestBase.defaultWaitTime(2000);
			objVerifyNewBookingMain.clickOnMyAddresses("profileOptionSimulatorView");
			objTestBase.defaultWaitTime(3000);
			
			visibilityStatus = objVerifyNewBookingMain.VerifyMyaddressesPage(visibilityStatus);
			testStep = "verify  User details page with Favorite addresses";
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)
					objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
				else
