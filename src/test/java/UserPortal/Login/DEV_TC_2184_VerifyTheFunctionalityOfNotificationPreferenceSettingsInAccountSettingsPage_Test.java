...
public class DEV_TC_2184_VerifyTheFunctionalityOfNotificationPreferenceSettingsInAccountSettingsPage_Test extends TestBase {
	...
	DEV_TC_2184_VerifyTheFunctionalityOfNotificationPreferenceSettingsInAccountSettingsPage_Main objVerifyNewBookingMain;
	DEV_TC_2184_VerifyTheFunctionalityOfNotificationPreferenceSettingsInAccountSettingsPage_Test objVerifyNewBookingTest;
	...
	public void ActivationOfNewUserAfterRegistration() throws Exception {
		try {
			...
			objVerifyNewBookingMain = new DEV_TC_2184_VerifyTheFunctionalityOfNotificationPreferenceSettingsInAccountSettingsPage_Main(driver);
			objVerifyNewBookingTest = new DEV_TC_2184_VerifyTheFunctionalityOfNotificationPreferenceSettingsInAccountSettingsPage_Test();
			objTestBase = new TestBase();
			...
			objTestBase.defaultWaitTime(2000);
			objVerifyNewBookingMain.clickOnAccountsSettings("profileOptionSimulatorView");
			objTestBase.defaultWaitTime(3000);
			
			visibilityStatus = objVerifyNewBookingMain.VerifyAccountsSettingsPage(visibilityStatus);
			testStep = "verify  Account settings page with notification preferences";
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)
					objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
				else
			...
			objTestBase.defaultWaitTime(2000);
			objVerifyNewBookingMain.clickOnTripUpdatesToggleBtn("profileOptionSimulatorView");
			objTestBase.defaultWaitTime(3000);
			
			visibilityStatus = objVerifyNewBookingMain.VerifyTripUpdatesToggleBtn(visibilityStatus);
			testStep = "verify Trip updates success message";
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)
					objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
				else
			...
			visibilityStatus = objVerifyNewBookingMain.VerifyTripConfirmationToggleBtn(visibilityStatus);
			testStep = "verify Trip Confirmation success message";
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)
					objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
				else
			...
			visibilityStatus = objVerifyNewBookingMain.VerifyTripUpdates24hrsToggleBtn(visibilityStatus);
			testStep = "verify Trip updates 24hrs success message";
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)
					objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
				else
