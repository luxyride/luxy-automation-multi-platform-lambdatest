...
public class DEV_TC_1967_VerifyTheFunctionalityOfDownloadTripInvoiceButtonInUpcomingTripsTabUnderProfileInWebUserPortal_Test extends TestBase {
	...
	DEV_TC_1967_VerifyTheFunctionalityOfDownloadTripInvoiceButtonInUpcomingTripsTabUnderProfileInWebUserPortal_Main objVerifyNewBookingMain;
	DEV_TC_1967_VerifyTheFunctionalityOfDownloadTripInvoiceButtonInUpcomingTripsTabUnderProfileInWebUserPortal_Test objVerifyNewBookingTest;
	...
	public void ActivationOfNewUserAfterRegistration() throws Exception {
		try {
			...
			objVerifyNewBookingMain = new DEV_TC_1967_VerifyTheFunctionalityOfDownloadTripInvoiceButtonInUpcomingTripsTabUnderProfileInWebUserPortal_Main(
					driver);
			objVerifyNewBookingTest = new DEV_TC_1967_VerifyTheFunctionalityOfDownloadTripInvoiceButtonInUpcomingTripsTabUnderProfileInWebUserPortal_Test();
			objTestBase = new TestBase();
	...
	public void continueBookingFlow(String scenario, String testStatus) {
		try {
			...
			visibilityStatus = objVerifyNewBookingMain.visibilityOfDownloadTripInvoiceBtn(visibilityStatus);
			testStep = "visibility Of Download Trip invoice Button in Upcomings trips";
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)
					objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
				else
