...
public class DEV_TC_2185_VerifyTheAvailabilityOfChangePasswordInAccountSettingsPage_Test extends TestBase {
	...
	DEV_TC_2185_VerifyTheAvailabilityOfChangePasswordInAccountSettingsPage_Main objVerifyNewBookingMain;
	DEV_TC_2185_VerifyTheAvailabilityOfChangePasswordInAccountSettingsPage_Test objVerifyNewBookingTest;
	...
	public void ActivationOfNewUserAfterRegistration() throws Exception {
		try {
			...
			objVerifyNewBookingMain = new DEV_TC_2185_VerifyTheAvailabilityOfChangePasswordInAccountSettingsPage_Main(driver);
			objVerifyNewBookingTest = new DEV_TC_2185_VerifyTheAvailabilityOfChangePasswordInAccountSettingsPage_Test();
			objTestBase = new TestBase();
