...
public class DEV_TC_2186_VerifyTheFunctionalityOfChangePasswordInAccountSettingsPage_Test extends TestBase {
	...
	DEV_TC_2186_VerifyTheFunctionalityOfChangePasswordInAccountSettingsPage_Main objVerifyNewBookingMain;
	DEV_TC_2186_VerifyTheFunctionalityOfChangePasswordInAccountSettingsPage_Test objVerifyNewBookingTest;
	...
	public void ActivationOfNewUserAfterRegistration() throws Exception {
		try {
			...
			objVerifyNewBookingMain = new DEV_TC_2186_VerifyTheFunctionalityOfChangePasswordInAccountSettingsPage_Main(
					driver);
			objVerifyNewBookingTest = new DEV_TC_2186_VerifyTheFunctionalityOfChangePasswordInAccountSettingsPage_Test();
			objTestBase = new TestBase();
			...
			testStep = "verify  Account settings page with Passwords fields";
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)
					objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
				else
			...
			testStep = "passwords  negative validation ";
			objTestBase.defaultWaitTime(1000);
			objVerifyNewBookingMain.enterOldPassword();
			objTestBase.defaultWaitTime(2000);
			objVerifyNewBookingMain.enternewPassword();
			objTestBase.defaultWaitTime(2000);
			objVerifyNewBookingMain.enterConfirmPassword();
			objTestBase.defaultWaitTime(2000);
			objVerifyNewBookingMain.clickOnSubmitBtn();
			objTestBase.defaultWaitTime(1000);

			visibilityStatus = objVerifyNewBookingMain.VerifyErrorMessage(visibilityStatus);
			testStep = "verify error message old password is incorrect ";
			if (visibilityStatus.booleanValue() == true) {
				if (localExecutionFlag == true)
					objupdateResults.updateResults(screenshotPath, logger, LogStatus.PASS, testStep, exception);
				else
